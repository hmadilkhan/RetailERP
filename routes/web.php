...
use App\Http\Controllers\Crm\LeadBoardController;
use App\Http\Controllers\Crm\LeadController;
use App\Http\Controllers\Crm\LeadAttachmentController;
...
Route::middleware(['roleChecker'])->group(function () {
    ...
    Route::post('/billing/invoices/{id}/discounts', [BillingController::class, 'addDiscount'])->name('billing.invoices.discounts.store');
...
Route::middleware(['statusCheck'])->group(function () {
    ...
    Route::prefix('crm')->as('crm.')->group(function () {
        ...
        Route::get('/board', [LeadBoardController::class, 'index'])->name('board');
        Route::get('/notifications/{notification}/open', [NotificationController::class, 'open'])->name('notifications.open');
        Route::post('/notifications/read-all', [NotificationController::class, 'readAll'])->name('notifications.read-all');
        Route::get('/dashboard/reports/{report}/export/excel', [DashboardController::class, 'exportExcel'])->name('dashboard.reports.export.excel');
        Route::get('/dashboard/reports/{report}/export/pdf', [DashboardController::class, 'exportPdf'])->name('dashboard.reports.export.pdf');
        Route::get('/leads/products', [LeadController::class, 'productsByType'])->name('leads.products');
        ...
        Route::patch('/leads/{lead}/board-status', [LeadBoardController::class, 'updateStatus'])->name('leads.board-status');
        Route::get('/leads/{lead}/quotations/create', [LeadQuotationController::class, 'create'])->name('leads.quotations.create');
        Route::post('/leads/{lead}/quotations', [LeadQuotationController::class, 'store'])->name('leads.quotations.store');
        Route::post('/leads/{lead}/followups', [LeadFollowupController::class, 'store'])->name('leads.followups.store');
        Route::post('/leads/{lead}/assign', [LeadController::class, 'assign'])->name('leads.assign');
        Route::post('/leads/{lead}/attachments', [LeadAttachmentController::class, 'store'])->name('leads.attachments.store');
        Route::get('/leads/{lead}/attachments/{attachment}/preview', [LeadAttachmentController::class, 'preview'])->name('leads.attachments.preview');
        Route::get('/leads/{lead}/attachments/{attachment}/download', [LeadAttachmentController::class, 'download'])->name('leads.attachments.download');
        Route::delete('/leads/{lead}/attachments/{attachment}', [LeadAttachmentController::class, 'destroy'])->name('leads.attachments.destroy');
        Route::get('/quotations/{quotation}', [LeadQuotationController::class, 'show'])->name('quotations.show');
        Route::get('/quotations/{quotation}/edit', [LeadQuotationController::class, 'edit'])->name('quotations.edit');
        Route::put('/quotations/{quotation}', [LeadQuotationController::class, 'update'])->name('quotations.update');
        Route::get('/quotations/{quotation}/pdf', [LeadQuotationController::class, 'pdf'])->name('quotations.pdf');
    ...
    Route::get('/itemsaledatabasepdf', [ReportController::class, 'newitemsaledatabasepdf'])->name('itemsaledatabasepdf');
    ...
    Route::get('/test-fpdf', [ReportController::class, 'testFpdf']);
