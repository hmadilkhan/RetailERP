  ...
  WHERE c.opening_id = a.opening_id
    ...
    public function getheadsDetailsFromOpeningIdForClosing($openingId)
    {
      ...
      WHERE opening_id = a.opening_id
        ...
        (SELECT SUM(received) FROM customer_account INNER JOIN sales_receipts on sales_receipts.id = customer_account.receipt_no  where customer_account.opening_id = a.opening_id and customer_account.payment_mode_id = 1 and total_amount = 0 and sales_receipts.status != 12) AS order_delivered_cash,
