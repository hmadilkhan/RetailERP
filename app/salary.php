...
class salary extends Model
{
  ...
  public function salary_details($fromdate, $todate, $branchid, $empid)
  {
    ...
    $result = DB::select('SELECT b.empid, a.date, b.emp_acc, b.emp_picture, b.emp_name, d.branch_name, a.gross_salary, a.deduction_salary, a.special_amount, a.net_salary FROM salary_details a INNER JOIN employee_details b ON b.empid = a.emp_id INNER JOIN employee_shift_details c ON c.emp_id = a.emp_id AND c.status_id = b.status_id INNER JOIN branch d ON d.branch_id = c.branch_id WHERE ' . $clause);
    return $result;
  }
