...
class Inventory_DepartmentController extends Controller
{
    ...
    public function index()
    {
        ...
        // }
	  $depart = inventory_department::with(['inventoryDepartmentSection:id,section_id'])->where('status',1)->orderBy('department_id','DESC')->get();//inventory_department::getdepartment('');
