...
class BranchController extends Controller
{
	...
	public function index(branch $branch)
	{
		...
		return view(session('roleId') == 1 ? 'v2.branch.create' : 'Branch.create', compact('country', 'city', 'company', 'reports'));
	}
	...
	public function edit(branch $branch, Request $request)
	{
		...
		return view(session('roleId') == 1 ? 'v2.branch.edit' : 'Branch.edit', compact('country', 'city', 'details', 'company', 'reports', 'branchreports'));
	}
