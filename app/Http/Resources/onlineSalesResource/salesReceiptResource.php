...
class salesReceiptResource extends JsonResource
{
	...
	public function toArray($request)
	{
		return [
			...
			"serviceType"   			=> $this->service_type_name,
			...
			"products"                  => ProductResource::customCollection(DB::table('inventory_general')
				...
				->select(
					...
					'sales_receipt_details.laundry_package_id',
					'sales_receipt_details.laundry_package_name',
					'sales_receipt_details.laundry_package_price',
					'inventory_general.image',
					'inventory_general.url',
					'inventory_department.department_name'
				)
