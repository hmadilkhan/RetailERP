...
class posProducts extends Model
{
    ...
    {
        $result = DB::select('SELECT a.pos_item_id, a.isPos,a.isOnline,a.isHide, a.item_code, a.item_name, a.image, c.branch_name, d.product_name, e.department_name, f.status_name, b.*, a.quantity,a.uom ,g.uom_id,g.name as uomname FROM pos_products_gen_details a
