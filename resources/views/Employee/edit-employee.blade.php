       ...
       <option {{$value->branch_name == $details[0]->branch_name ? 'selected="selected"' : '' }} 
		...
		<div class="col-lg-4 col-md-4" id="dvtaxes">
         ...
         <div class="row">
                <div class="col-lg-4 col-md-4">
                <a href="#">
                <img id="empimgs" src="{{ asset('assets/images/employees/images/'.(!empty($details[0]->emp_picture) ? $details[0]->emp_picture : 'placeholder.jpg').'') }}" class="thumb-img img-fluid width-100" alt="img" style="width: 128px;height: 128px;">
                </a>
             ...
             <div class="col-lg-4 col-md-4">
                 <a href="#">
                     <img id="docimgs1" src="{{ asset('assets/images/employees/documents/'.(!empty($details[0]->document1) ? $details[0]->document1 : 'placeholder.jpg').'') }}" class="thumb-img img-fluid width-100" alt="img" style="width: 128px;height: 128px;">
                 </a>
             ...
             <div class="col-lg-4 col-md-4">
                 <a href="#">
                     <img id="docimgs2" src="{{ asset('assets/images/employees/documents/'.(!empty($details[0]->document2) ? $details[0]->document2 : 'placeholder.jpg').'') }}" class="thumb-img img-fluid width-100" alt="img" style="width: 128px;height: 128px;">
                 </a>
