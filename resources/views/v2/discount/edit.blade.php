...
<form id="discountform" class="w-full" method="post" action="{{url('update-discount')}}">
  @method('post')
  @csrf
  <input type="hidden" id="discount_id" name="discount_id" value="{{$discountGen[0]->discount_id}}">
  ...
  <input type="hidden" id="type" name="type" value="{{$discountGen[0]->discount_type}}">
  <div id="daysdiv"></div>
  <div class="w-full">
    <div class="card card-block">
      <div class="col-lg-12 col-md-12">
        <div class="form-group">
          ...
          <input disabled="" class="form-control" type="text" name="code" id="code" value="{{$discountGen[0]->discount_code}}" />
      ...
      <div class="card-block">
        ...
        <div class="col-lg-12 col-md-12">
          <div class="form-group">
            ...
            <select name="website" id="website" data-placeholder="Select Website" class="form-control select2" readonly>
              <option value="">Select Website</option>
              @if($websites)
              @foreach($websites as $website)
              <option {{$discountGen[0]->website_id == $website->id ? 'selected' : ''}} value="{{$website->id}}">{{$website->name}}</option>
              @endforeach
              @endif
            </select>
        ...
        <div class="col-lg-12 col-md-12">
          <div class="form-radio">
            <form>
              ...
              <div class="radio radiofill ">
                <label class="pointer">
                  <input disabled="" type="radio" name="radio" id="product" value="selected products" onchange="radiochange(this.id)" /><i class="helper"></i>Selected Products <a class="text-primary" >( Show All products )</a>
                </label>
              </div>
            </form>
          </div>
    ...
    <div class="card">
     ...
     <div class="rkmd-checkbox checkbox-rotate checkbox-ripple f-right"> 
      <label class="input-checkbox checkbox-primary">
            <input type="checkbox" id="selectedAlldays" {{ count($selectedDays) == 7 ? 'checked' : '' }}>
            <span class="checkbox"></span>
            <span class="ripple"></span></label>
      ...
      <div class="card-block">
        <div class="col-lg-2 col-md-2 rkmd-checkbox checkbox-rotate checkbox-ripple">
          <label class="input-checkbox checkbox-primary">
            <input type="checkbox" onclick="selectedCheckbox('mon', value)" id="mon" {{ in_array('mon',$selectedDays->toArray()) ? 'checked' : '' }}>
            <span class="checkbox"></span>
            <span class="ripple"></span></label>
          <div class="captions">Monday</div>
        </div>
        <div class="col-lg-2 col-md-2 rkmd-checkbox checkbox-rotate checkbox-ripple">
          <label class="input-checkbox checkbox-primary">
            <input type="checkbox" onclick="selectedCheckbox('tue', value)" id="tue" {{ in_array('tue',$selectedDays->toArray()) ? 'checked' : '' }}>
            <span class="checkbox"></span>
            <span class="ripple"></span></label>
          <div class="captions">Tuesday</div>
        </div>
        <div class="col-lg-2 col-md-2 rkmd-checkbox checkbox-rotate checkbox-ripple">
          <label class="input-checkbox checkbox-primary">
            <input type="checkbox" onclick="selectedCheckbox('wed', value)" id="wed" {{ in_array('wed',$selectedDays->toArray()) ? 'checked' : '' }}>
            <span class="checkbox"></span>
            <span class="ripple"></span></label>
          <div class="captions">Wednesday</div>
        </div>
        <div class="col-lg-2 col-md-2 rkmd-checkbox checkbox-rotate checkbox-ripple">
          <label class="input-checkbox checkbox-primary">
            <input type="checkbox" onclick="selectedCheckbox('thu', value)" id="thu" {{ in_array('thu',$selectedDays->toArray()) ? 'checked' : '' }}>
            <span class="checkbox"></span>
            <span class="ripple"></span></label>
          <div class="captions">Thursday</div>
        </div>
        <div class="col-lg-2 col-md-2 rkmd-checkbox checkbox-rotate checkbox-ripple">
          <label class="input-checkbox checkbox-primary">
            <input type="checkbox" onclick="selectedCheckbox('fri', value)" id="fri" {{ in_array('fri',$selectedDays->toArray()) ? 'checked' : '' }}>
            <span class="checkbox"></span>
            <span class="ripple"></span></label>
          <div class="captions">Friday</div>
        </div>
        <div class="col-lg-2 col-md-2 m-t-2 rkmd-checkbox checkbox-rotate checkbox-ripple">
          <label class="input-checkbox checkbox-primary">
            <input type="checkbox" onclick="selectedCheckbox('sat', value)" id="sat" {{ in_array('sat',$selectedDays->toArray()) ? 'checked' : '' }}>
            <span class="checkbox"></span>
            <span class="ripple"></span></label>
          <div class="captions">Saturday</div>
        </div>
        <div class="col-lg-2 col-md-2 m-t-2 rkmd-checkbox checkbox-rotate checkbox-ripple">
          <label class="input-checkbox checkbox-primary">
            <input type="checkbox" onclick="selectedCheckbox('sun', value)" id="sun" {{ in_array('sun',$selectedDays->toArray()) ? 'checked' : '' }}>
            <span class="checkbox"></span>
            <span class="ripple"></span></label>
          <div class="captions">Sunday</div>
        </div>
      </div>
    </div>
...
<div class="card w-full">
  ...
  <div class="col-lg-12 col-md-12">
    <h2 id="salename">{{$discountGen[0]->discount_code}}</h2>
  </div>
  <div class="col-lg-12 col-md-12 m-l-30 m-b-20 ">
    <ul id="description" style="list-style-type:disc;">
      <div id="disc_website">Website:{{ $discountGen[0]->website_name }}</div>
...
<script type="text/javascript">
  ...
  function loadProducts() {
    $.ajax({
      ...
      type: "GET",
      data: {
        discount_id: "{{$discountGen[0]->discount_id}}"
      },
      success: function(result) {
  ...
  var daysArray = @json($selectedDays);
