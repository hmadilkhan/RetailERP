...
@section('content')
    ...
    <section class="panels-wells">
        ...
        <form method="POST" id="inventCreateForm" class="form-horizontal" enctype="multipart/form-data"
            action="{{ route('insert') }}">
            @csrf
                        ...
                        <div class="card-block p-2 p-t-0">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div id="itemcode"
                                        ...
                                        <input class="form-control" type="text" name="pctcode" id="pctcode"
                                            value="{{ old('pctcode') }}" placeholder="Enter Product Code" />
                                ...
                                <div class="col-lg-12 col-md-4">
                                    <div class="form-group {{ $errors->has('name') ? 'has-danger' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="name" id="name"
                                            value="{{ old('name') }}" onchange="samename()"
                                            placeholder="Enter Product Name" />
                                        @if ($errors->has('name'))
                                            <div class="form-control-feedback" id="nameerror">{{ $errors->first('name') }}
                                            </div>
                                        @endif
                                            ...
                                            @if ($uom)
                                                @foreach ($uom as $val)
                                                    @if (old('uom') == $val->uom_id)
                                                        <option selected="selected" value="{{ $val->uom_id }}">
                                                            {{ $val->name }}</option>
                                                    @else
                                            ...
                                            @if ($mode)
                                                @foreach ($mode as $val)
                                                    @if (old('product_mode') == $val->product_mode_id)
                                                        <option selected="selected" value="{{ $val->product_mode_id }}">
                                                            {{ $val->product_name }}</option>
                                                    @else
                                                        <option value="{{ $val->product_mode_id }}">
                                                            {{ $val->product_name }}</option>
                                                    @endif
                                                @endforeach
                                            @endif
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="Number" min="0" name="reminder"
                                            id="reminder" value="{{ old('reminder') }}"
                                    ...
                                    <div class="form-group {{ $errors->has('cuom') ? 'has-danger' : '' }}">
                                        ...
                                        <select class="form-control select2" data-placeholder="Select Vendors"
                                            id="vendor" name="vendor[]" multiple>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group {{ $errors->has('inventory_type') ? 'has-danger' : '' }}">
                                        <label class="form-control-label">Inventory Type <span
                                                class="text-danger">*</span></label>
                                                ...
                                                @foreach ($types as $key => $type)
                                                    @if (old('inventory_type') == $type->id)
                                                        <option selected="selected" value="{{ $type->id }}">
                                                            {{ $type->name }}</option>
                                                    @else
                                                        <option @selected($key == 0) value="{{ $type->id }}">
                                                            {{ $type->name }}</option>
                                                    @endif
                                                @endforeach
                                            @endif
                                    ...
                                    <div class="form-group {{ $errors->has('brand') ? 'has-danger' : '' }}">
                                        ...
                                        <select class="form-control  select2" data-placeholder="Select Brand"
                                            ...
                                            @foreach ($brandList as $val)
                                                <option {{ old('brand') == $val->id ? 'selected' : '' }}
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ $errors->has('tags') ? 'has-danger' : '' }}">
                                        ...
                                        <select class="form-control  select2" data-placeholder="Select Tags"
                                            id="tags" name="tags[]" multiple>
                                            <option value="">Select</option>
                                            @php $oldTag = (array) old('tag') @endphp
                                            @foreach ($tagsList as $val)
                                                <option {{ in_array($val->id, $oldTag) ? 'selected' : '' }}
                                                    value="{{ $val->id }}">{{ $val->name }}</option>
                                            @endforeach
                                        </select>
                                        @if ($errors->has('tags'))
                            ...
                            @if (count($websites) > 0)
                                ...
                                <div class="d-none" id="website-module">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group {{ $errors->has('website') ? 'has-danger' : '' }}">
                                                ...
                                                @if ($errors->has('website'))
                                                    <span class="form-control-feedback">Required field can not be
                                                        blank.</span>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="row d-none" id="editorDiv">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group ">
                                    ...
                                    <div class="row d-none" id="nonEditorDiv">
                                        <div class="col-md-12">
                                            <div class="form-group ">
                                                ...
                                                <textarea class="form-control" name="product_description_resturant_website"
                                                    id="product_description_resturant_website" rows="6"></textarea>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-block p-2">
                                ...
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group {{ $errors->has('cost_price') ? 'has-danger' : '' }}">
                                        ...
                                        <input class="form-control" type="text"
                                            ...
                                            id="cost_price" value="{{ old('cost_price') }}" placeholder="0" />
                                    </div>
                                </div>
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group {{ $errors->has('ap') ? 'has-danger' : '' }}">
                                        ...
                                        <input class="form-control" type="text"
                                            ...
                                            id="ap" value="{{ old('ap') }}" placeholder="0" />
                                        @if ($errors->has('ap'))
                                            <span class="form-control-feedback">Required field can not be blank.</span>
                                        @endif
                                    </div>
                                ...
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="Number" min="0" name="taxamount"
                                            id="taxamount" value="{{ old('taxamount') }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group {{ $errors->has('rp') ? 'has-danger' : '' }}">
                                        ...
                                        <input class="form-control" type="text"
                                            ...
                                            id="rp" placeholder="0" value="{{ old('rp') }}" />
                                        @if ($errors->has('rp'))
                                            <span class="form-control-feedback">Required field can not be blank.</span>
                                        @endif
                                    </div>
                                ...
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div class="rkmd-checkbox checkbox-rotate">
                                        <label class="input-checkbox checkbox-primary">
                                            <input type="checkbox" id="chkactive" name="chkactive" class="mainchk"
                                                onchange="toggle()" {{ old('chkactive') ? 'checked' : '' }}>
                                            <span class="checkbox"></span>
                                        </label>
                                        <div class="captions text-info f-16 m-b-5">If you want to sale this product in POS
                                            so please enter here name, item code and also selling price.</div>
                                    </div>
                                </div>
                            ...
                            <div class="row" id="posdiv" style="display: none;">
                                <div class="col-lg-3 col-md-4">
                                    <div id="positemcode"
                                        class="form-group {{ $errors->has('poscode') ? 'has-danger' : '' }} ">
                                        <label class="form-control-label"><i
                                                class="icofont icofont-barcode"></i>&nbsp;Enter POS Inventory Code</label>
                                        <input type="text" name="poscode" id="poscode" class="form-control"
                                            value="{{ old('poscode') }}" />
                                ...
                                <div class="col-lg-3 col-md-4">
                                    <div class="form-group {{ $errors->has('posname') ? 'has-danger' : '' }} ">
                                        ...
                                        <input type="text" name="posname" id="posname" class="form-control"
                                            value="{{ old('posname') }}" />
                                ...
                                <div class="col-lg-3 col-md-3">
                                    <div class="form-group {{ $errors->has('posuom') ? 'has-danger' : '' }}">
                                        <label class="form-control-label">POS Unit Measure<span
                                                class="text-danger m-l-5">*</span></label>
                                        <i id="btn_uom" class="icofont icofont-plus f-right text-success"
                                            data-toggle="tooltip" data-placement="top" title="Add UOM"></i>
                                        <select class="form-control  select2" data-placeholder="Select Unit Measure"
                                            id="posuom" name="posuom">
                                ...
                                <div class="col-lg-3 col-md-4">
                                    <div class="form-group {{ $errors->has('posprice') ? 'has-danger' : '' }} ">
                                        ...
                                        <input type="text" name="posprice" id="posprice" class="form-control"
                                            value="{{ old('posprice') }}" />
                            ...
                            <div class="row m-t-20">
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div class="rkmd-checkbox checkbox-rotate">
                                        <label class="input-checkbox checkbox-primary">
                                            <input type="checkbox" id="chkstock" name="chkstock" class="mainchk"
                                                onchange="togglestock()" {{ old('chkstock') ? 'checked' : '' }}>
                                            <span class="checkbox"></span>
                                        </label>
                                        <div class="captions text-info f-16 m-b-5">If you want to perform stock opening,
                                            please enter cost and qty for the specific product.</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-block p-2 p-t-0">
                            <div class="form-group">
                                <a href="javascript:void(0)">
                                    <img id="simg" src="{{ asset('storage/images/placeholder.jpg') }}"
                                        class="max-height-100 width-100 m-b-15" alt="img">
                                </a>
                                ...
                                <div class="form-group {{ $errors->has('image') ? 'has-danger' : '' }} m-t-10">
                                    ...
                                    <div>
                                        <label class="pointer"><input type="checkbox" name="actual_image_size"
                                                class=""> You want to actual image size</label>
                                    </div>
                                    @if ($errors->has('image'))
            ...
            <div class="row m-t-30">
                <div class="col-lg-12 col-md-12 text-center">
                    <button id="btnSubmit" class="btn btn-lg btn-circle btn-primary m-b-10" type="submit"><i
                            class="icofont icofont-plus"></i>&nbsp;Submit Details</button>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" id="btn_brand_md" class="btn btn-success waves-effect waves-light"
                            onClick="insertProduct_attribute('brand')">Add</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade modal-flex" id="subdepart-modal" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="subdepartname" id="subdepartname"
                                        class="form-control" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success waves-effect waves-light"
                            onClick="addsubdepart()">Add Sub Department</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        $('#inventCreateForm').on('submit', function() {
            ...
            if (!regex.test(itemName.val())) {
                ...
                $('#btnSubmit').prop('disabled', false).html(
                    '<i class="icofont icofont-plus"></i>  Submit Details');
                itemName.focus();
                swal('Error!',
