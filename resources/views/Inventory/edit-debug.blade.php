          ...
          <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text"
                   name="meta_title" id="meta_title"  value="{{ old('meta_title') ?  old('meta_title') : $data[0]->meta_title }}" placeholder="Enter Product Meta Title"/>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="form-group">
                   ...
                   name="meta_description" id="meta_description"  placeholder="Enter Product Meta Description"> {{ old('meta_description') ? old('meta_description') : $data[0]->meta_description }}</textarea>
                </div>
            </div>
          </div>
