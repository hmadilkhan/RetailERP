...
@section('content')
    ...
    <div class="main-header m-t-0">
        ...
        <a href="{{ route('invent-list') }}">
            <i class="text-primary text-center icofont icofont-arrow-left m-t-10 f-18" data-toggle="tooltip"
                data-placement="top" title="" data-original-title="Back to list ">
                Back to list</i>
        </a>
    </div>
    <section class="panels-wells">
        <form id="inventoryupdate" method="post" class="form-horizontal" enctype="multipart/form-data"
            action="{{ route('update') }}">
            {{-- @method('POST') --}}
            @csrf
                ...
                <div class="col-md-9">
                    <div class="card b-radius">
                        ...
                        <div class="card-block p-2 p-t-0">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('depart') ? 'has-danger' : '' }}">
                                        ...
                                        <i id="btn_depart" class="icofont icofont-plus f-right text-success"
                                            data-toggle="tooltip" data-placement="top" title="Add Department"></i>
                                        <select class="form-control  select2" data-placeholder="Select Department"
                                            ...
                                            @if ($department)
                                                ...
                                                @foreach ($department as $val)
                                                    <option {{ $departmentValue == $val->department_id ? 'selected' : '' }}
                                                        value="{{ $val->department_id }}">{{ $val->department_name }}
                                                    </option>
                                                @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('subDepart') ? 'has-danger' : '' }}">
                                        <label class="form-control-label">Sub Department<span
                                                class="text-danger m-l-5">*</span></label>
                                        <i id="btn_subdepart" class="icofont icofont-plus f-right text-success"
                                            data-toggle="tooltip" data-placement="top" title="Add Sub Department"></i>
                                        <select class="form-control  select2" data-placeholder="Select Sub Department"
                                            id="subDepart" name="subDepart">
                                            <option value="">Select Sub Department</option>
                                            @if ($subdepartment)
                                                @php $subDepartment = old('subDepart') ? old('subDepart') : $data[0]->sub_department_id @endphp
                                                @foreach ($subdepartment as $val)
                                                    <option
                                                        {{ $subDepartment == $val->sub_department_id ? 'selected' : null }}
                                                        value="{{ $val->sub_department_id }}">{{ $val->sub_depart_name }}
                                                    </option>
                                                @endforeach
                                            @endif
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div id="itemcode" class="form-group {{ $errors->has('code') ? 'has-danger' : '' }} ">
                                        ...
                                        <i id="btngen" class="f-right text-primary" data-toggle="tooltip"
                                            data-placement="top" title="Auto Generate"> Auto Generate</i>
                                        <input class="form-control" type="text" name="code" id="code"
                                            value="{{ old('code') ? old('code') : $data[0]->item_code }}"
                                            placeholder="Enter Product Code" onchange="samecode()" />
                                        @if ($errors->has('code'))
                                            <div class="form-control-feedback">Required field can not be blank.</div>
                                        @endif
                                    </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group {{ $errors->has('name') ? 'has-danger' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="name" id="name"
                                            value="{{ old('name') ? old('name') : $data[0]->product_name }}"
                                            onchange="samename()" placeholder="Enter Product Name" />
                                        @if ($errors->has('name'))
                                            <div class="form-control-feedback" id="nameerror">Required field can not be
                                                blank.</div>
                                        @endif
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group {{ $errors->has('uom') ? 'has-danger' : '' }}">
                                        <label class="form-control-label">Unit Measure <span
                                                class="text-danger">*</span></label>
                                        <i id="btn_uom" class="icofont icofont-plus f-right text-success"
                                            data-toggle="tooltip" data-placement="top" title="Add UOM"></i>
                                        <select class="form-control  select2" data-placeholder="Select Unit Measure"
                                            id="uom" name="uom">
                                            <option value="">Unit Measure</option>
                                            @if ($uom)
                                                @php $uomValue = old('uom') ? old('uom') : $data[0]->uom_id @endphp
                                                @foreach ($uom as $val)
                                                    <option {{ $uomValue == $val->uom_id ? 'selected' : '' }}
                                                        value="{{ $val->uom_id }}">{{ $val->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        @if ($errors->has('uom'))
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ $errors->has('weight') ? 'has-danger' : '' }}">
                                        ...
                                        <input class="form-control" type="text" onkeypress="return myfunction(event);"
                                            ...
                                            value="{{ old('weight') ? old('weight') : $data[0]->weight_qty }}"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ $errors->has('cuom') ? 'has-danger' : '' }}">
                                        <label class="form-control-label">Conversion Unit Measure <span
                                                class="text-danger">*</span></label>
                                        <i id="btn_uom" class="icofont icofont-plus f-right text-success"
                                            data-toggle="tooltip" data-placement="top" title="Add UOM"></i>
                                        <select class="form-control  select2" data-placeholder="Select Unit Measure"
                                            ...
                                            @if ($uom)
                                                ...
                                                @foreach ($uom as $val)
                                                    <option {{ $cuomValue == $val->uom_id ? 'selected' : '' }}
                                                        value="{{ $val->uom_id }}">{{ $val->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ $errors->has('product_mode') ? 'has-danger' : '' }}">
                                        <label class="form-control-label">Product Mode <span
                                                class="text-danger">*</span></label>
                                        <select class="form-control  select2" data-placeholder="Select Product Mode"
                                            id="product_mode" name="product_mode" onchange="toggle()">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-control-label">Qty Reminder <span
                                                class="text-danger">*</span></label>
                                        <input class="form-control" type="Number" min="0" name="reminder"
                                            id="reminder"
                                            value="{{ old('reminder') ? old('reminder') : $data[0]->reminder_qty }}"
                                            placeholder="Enter Quantity Reminder" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3">
                                    <div class="form-group {{ $errors->has('brand') ? 'has-danger' : '' }}">
                                        ...
                                        <i data-toggle="modal" data-target="#createbrand-modal"
                                            class="icofont icofont-plus f-right text-success" data-toggle="tooltip"
                                            data-placement="top" title="" data-original-title="Add Brand"></i>
                                        <select class="form-control  select2" data-placeholder="Select Brand"
                                            id="brand" name="brand">
                                            <option value="">Select</option>
                                            @php $brandOld_val = old('brand') ? old('brand') : $data[0]->brand_id @endphp
                                            @foreach ($brandList as $val)
                                                <option {{ $brandOld_val == $val->id ? 'selected' : '' }}
                                ...
                                <div class="col-md-3">
                                    <div class="form-group {{ $errors->has('tags') ? 'has-danger' : '' }}">
                                        ...
                                        <i data-toggle="modal" data-target="#createtag-modal"
                                            class="icofont icofont-plus f-right text-success" data-toggle="tooltip"
                                            data-placement="top" title="" data-original-title="Add Tag"></i>
                                        <select class="select2" data-placeholder="Select Tags" id="tags"
                                            name="tags[]" multiple>
                                            <option value="">Select</option>
                                            @if ($tagsList)
                                                @php $tagsOld_val = old('tags') ? (array) old('tags') : $inventoryTags->toArray(); @endphp
                                                @foreach ($tagsList as $val)
                                                    <option {{ in_array($val->id, $tagsOld_val) ? 'selected' : '' }}
                                                        value="{{ $val->id }}">{{ $val->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                            ...
                            @if (count($websites) > 0)
                                ...
                                <div class="{{ count($selectedWebsites->toArray()) > 0 ? '' : 'd-none' }}"
                                    id="website-module">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group {{ $errors->has('website') ? 'has-danger' : '' }}">
                                                <label class="form-control-label">Select Website (Select on where product
                                                    to show)</label>
                                                <select class="form-control  select2" data-placeholder="Select Website"
                                                    id="website" name="website">
                                                    <option value="">Websites</option>
                                                    @if ($websites)
                                                        @foreach ($websites as $website)
                                                            <option
                                                                {{ in_array($website->id, $selectedWebsites->toArray()) ? 'selected="selected"' : '' }}
                                                                value="{{ $website->id }}">{{ $website->name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                                @if ($errors->has('website'))
                                                    <div class="form-control-feedback">Required field can not be blank.
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3">
                                            <div class="form-group {{ $errors->has('priority') ? 'has-danger' : '' }}">
                                                ...
                                                <input type="number" class="form-control" name="priority"
                                                    min="0"
                                                    value="{{ old('priority') ? old('priority') : $data[0]->priority }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                @if (!empty($data[0]->short_description))
                                                    @php
                                                        $short_description = html_entity_decode(
                                                ...
                                                <label class="form-control-label">Short Description <i>(For Website Only) -
                                                        Features</i></label>
                    ...
                    @endif --}}
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            ...
                                            @endif
                                            <div class="form-group ">
                                                <label class="form-control-label">Details <i>(For Website Only) -
                                                        Applications</i></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 {{ $websiteType == 'restaurant' ? 'd-none' : '' }}"
                                            id="nonEditorDiv">
                                            <div class="form-group ">
                                                <label class="form-control-label">Details <i>(For Website Only)</i></label>
                                                <textarea class="form-control" name="product_description_resturant_website"
                                                    id="product_description_resturant_website" rows="6">{{ $data[0]->product_description_resturant_website }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="meta_title"
                                                    id="meta_title"
                                                    value="{{ old('meta_title') ? old('meta_title') : $data[0]->meta_title }}"
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" class="form-control" name="meta_description" id="meta_description"
                                                    placeholder="Enter Product Meta Description"> {{ old('meta_description') ? old('meta_description') : $data[0]->meta_description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group {{ $errors->has('cost_price') ? 'has-danger' : '' }}">
                                        <label class="form-control-label">Cost Price:<span
                                                class="text-danger m-l-5">*</span></label>
                                        <input class="form-control" type="text"
                                            onkeypress="return isDecimalKey(event,this)" min="0" name="cost_price"
                                            id="cost_price"
                                            value="{{ old('cost_price') ? old('cost_price') : $prices[0]->cost_price }}"
                                            placeholder="0" />
                                    </div>
                                </div>
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group {{ $errors->has('ap') ? 'has-danger' : '' }}">
                                        <label class="form-control-label">Actual Price:<span
                                                class="text-danger m-l-5">*</span></label>
                                        <input class="form-control" type="text"
                                            onkeypress="return isDecimalKey(event,this)" min="0" name="ap"
                                            id="ap" value="{{ old('ap') ? old('ap') : $prices[0]->actual_price }}"
                                            placeholder="0" />
                                        @if ($errors->has('ap'))
                                            <div class="form-control-feedback">Required field can not be blank.</div>
                                        @endif
                                ...
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="Number" step=".01" name="taxrate"
                                            id="taxrate"
                                            value="{{ old('taxrate') ? old('taxrate') : $prices[0]->tax_rate }}" />
                                    </div>
                                </div>
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group">
                                        <label class="form-control-label">Tax Amount:</label>
                                        <input class="form-control" type="Number" min="0" name="taxamount"
                                            id="taxamount"
                                            value="{{ old('taxamount') ? old('taxamount') : $prices[0]->tax_amount }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group {{ $errors->has('rp') ? 'has-danger' : '' }}">
                                        <label class="form-control-label">Retail Price<span
                                                class="text-danger m-l-5">*</span></label>
                                        <input class="form-control" type="text"
                                            onkeypress="return isDecimalKey(event,this)" min="0" name="rp"
                                            id="rp" placeholder="0"
                                            value="{{ old('rp') ? old('rp') : $prices[0]->retail_price }}" />
                                        @if ($errors->has('rp'))
                                            <div class="form-control-feedback">Required field can not be blank.</div>
                                        @endif
                                    </div>
                                ...
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text"
                                            onkeypress="return isDecimalKey(event,this)" min="0" name="wp"
                                            id="wp"
                                            value="{{ old('wp') ? old('wp') : $prices[0]->wholesale_price }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text"
                                            onkeypress="return isDecimalKey(event,this)" min="0" name="dp"
                                            id="dp"
                                            value="{{ old('dp') ? old('dp') : $prices[0]->discount_price }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text"
                                            onkeypress="return isDecimalKey(event,this)" min="0" name="op"
                                            id="op"
                                            value="{{ old('op') ? old('op') : $prices[0]->online_price }}" />
                                    </div>
                                </div>
                            </div> <!--card block-->
                        </div> <!-- card div close -->
                        ...
                        @else --}}
                               ...
                               @endif --}}
                                ...
                                <a href="{{ $imageUrl }}" data-toggle="lightbox"
                                    data-title="{{ $data[0]->product_name }}">
                                    <img id="simg" src="{{ $imageUrl }}"
                                        class="max-height-100 width-100 m-b-15"
                                        alt="{{ empty($data[0]->image) ? $data[0]->image : 'placeholder.jpg' }}">
                                </a>
                                <br />
                                ...
                                <div>
                                    <label class="pointer"><input type="checkbox" name="actual_image_size"
                                            class="" {{ $data[0]->actual_image_size == 1 ? 'checked' : '' }}> You
                                        want to actual image size</label>
                                </div>
                                @if ($errors->has('image'))
                                        ...
                                        @foreach ($images as $val)
                                            @if (empty($val->url))
                                                <div style="position: relative; display: inline-block; margin: 10px;"
                                                    id="gallery-{{ $val->id }}">
                                                    <img src="{{ asset('storage/images/products/' . $val->image) }}"
                                                        style="max-width: 75px; max-height: 75px; object-fit: cover;">
                                                    <button type="button"
                                                        onclick="removeImage({{ $val->id }},'{{ $val->image }}')"
                                                        style="position: absolute; top: -6px; right: -6px; background-color: red; color:
                            white; border: none; border-radius: 50%; cursor: pointer; font-size: 12px;">
                                                        ✖</button>
                                                </div>
                                            @else
                                                <div id="urlgallery-{{ $val->id }}"
                                                    style="position: relative; display: inline-block; margin: 10px;">
                                                    <img src="{{ $val->url }}"
                                                        style="max-width: 75px; max-height: 75px; object-fit: cover;">
                                                    <button type="button"
                                                        onclick="removeImageUrl({{ $val->id }},'{{ $val->image }}')"
                                                        style="position: absolute; top: -6px; right: -6px; background-color: red; color:
                            white; border: none; border-radius: 50%; cursor: pointer; font-size: 12px;">
                                                        ✖</button>
                                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="prodgallery" class="custom-file">
                                        <input type="file" name="prodgallery[]" id="prodgallery"
                                            onchange="readURL_multiple(this,'imgGalleryBox')" class="custom-file-input"
                                            multiple>
                                        <span class="custom-file-control"></span>
                                    </label>
                                </div>
                            ...
                            <div class="card-block p-2 p-t-0">
                                <div id="videoPreviewBox">
                                    @if ($inventoryVideo != null)
                                        ...
                                        <video controls width="300" height="300">
                                            <source src="{{ asset('storage/video/products/' . $inventoryVideo->file) }}"
                                                type="video/{{ $videoExtension }}">
                                        </video>
                                        <button type="button" onclick="removeOldVideo('{{ $inventoryVideo->file }}')"
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="productvideo" class="custom-file">
                                        <input type="file" name="prodvideo" id="productvideo"
                                            onchange="handleVideo(this,'videoPreviewBox')" class="custom-file-input">
                                        <span class="custom-file-control"></span>
                                    </label>
                                </div>
                            </div>
            ...
            <div class="row m-t-30">
                <div class="col-lg-12 col-md-12 text-center">
                    <button class="btn btn-lg btn-circle btn-primary m-b-10" type="submit"
                        id="btn_submit_save_changes">Save Changes</button>
                </div>
            </div>
        </form>
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn_tag_md" class="btn btn-success waves-effect waves-light"
                        onClick="insertProduct_attribute('tag')">Add</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade modal-flex" id="uom-modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn_bank" class="btn btn-success waves-effect waves-light"
                        onClick="adduom()">Add</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade modal-flex" id="depart-modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success waves-effect waves-light" onClick="adddepartment()">Add
                        Department</button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade modal-flex" id="subdepart-modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <select class="form-control  select2" data-placeholder="Select Department"
                                    id="departmodal" name="departmodal">
                                    <option value="">Select Department</option>
                                    @if ($department)
                                        @foreach ($department as $val)
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success waves-effect waves-light" onClick="addsubdepart()">Add
...
@section('scriptcode_three')
    ...
    <script type="text/javascript">
        ...
        $('#inventoryupdate').submit(function(e) {
            ...
            if (process) {
                $.ajax({
                    ...
                    processData: false,
                    beforeSend: function() {
                        $("#btn_submit_save_changes").attr('disabled', true).html(
            ...
            if (input.files) {
                ...
                for (i = 0; i < filesAmount; i++) {
                    ...
                    reader.onload = function(event) {
                        $($.parseHTML('<img width=200 height=200 style="margin-left:20px;margin-top:20px;">')).attr(
                ...
                success: function(result) {
                    ...
                    $.each(result, function(i, value) {
                        if (value.sub_department_id == depart) {
                            $('#subDepart').append($('<option selected>').text(value.sub_depart_name)
                                .attr('value', value.sub_department_id));
                        } else {
                            $('#subDepart').append($('<option>').text(value.sub_depart_name).attr(
                                'value', value.sub_department_id));
                        }
                    ...
                    success: function(resp) {
                        if (resp != 0) {
                            ...
                            for (var count = 0; count < resp.length; count++) {
                                ...
                                $("#uom").append(
                                    "<option value='" + resp[count].uom_id + "'>" + resp[count].name +
                                    "</option>");
                            }
                        } else {
                            swal({
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        ...
                        if (resp != 0) {
                            ...
                            for (var count = 0; count < resp.length; count++) {
                                $("#depart").append("<option value='" + resp[count].department_id + "'>" + resp[
                                    count].department_name + "</option>");
                                $("#departmodal").append("<option value='" + resp[count].department_id + "'>" +
                                    resp[count].department_name + "</option>");
                            }
                        } else {
                            swal({
                                title: "Already exsist",
                    ...
                    success: function(resp) {
                        if (resp != 0) {
                            ...
                            for (var count = 0; count < resp.length; count++) {
                                ...
                                $("#subDepart").append(
                                    "<option value='" + resp[count].sub_department_id + "'>" + resp[count]
        ...
        function blockSpecialChar(e) {
            ...
            return ((k > 64 && k < 91) || (k > 96 && k < 123) || k == 8 || k == 32 || (k >= 40 && k <= 42) || (k >= 48 &&
                k <= 57));
        ...
        function myfunction(e) {
            return e.charCode === 0 || ((e.charCode >= 48 && e.charCode <= 57) || (e.charCode == 46 && document
                .getElementById("test").value.indexOf('.') < 0));
        }
