        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="row">
                    ...
                    @endif
                    <div
                        class="col-lg-{{ session('roleId') == 17 ? 3 : 6 }} col-md-{{ session('roleId') == 17 ? 3 : 6 }}">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            <h6>Note:</h6>
                            <ol>
                                <li>If you want to Enter Damaged/Spoilage/Wastage Stock so please Enter Quantity in Negative
                                    Figuers (-ve).</li>
                ...
                <div class="button-group ">
                    <button type="button" id="btngrn" class="btn btn-md btn-primary waves-effect waves-light f-right"
                        onclick="creategrn()"> <i class="icofont icofont-plus"> </i>
                        Stock Adjustment
                    </button>
                </div>
            </div>
            ...
            <div class="card-block">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group">
                            <table id="tblgrn" class="table dt-responsive table-striped nowrap" width="100%"
                                cellspacing="0">
                ...
                <div class="button-group ">
                    <button type="button" id="btnsubmit" class="btn btn-md btn-success waves-effect waves-light f-right"
                        onclick="adjuststock()"> <i class="icofont icofont-plus"> </i>
                        Stock Adjustment
                    </button>
                </div>
                ...
                success: function(result) {
                    $.each(result.data, function(index, value) {
                        $("#inventtbl tbody").append(
                            "<tr style='cursor: pointer' onclick='selectproduct(" + value.id + "," +
                            "\"" + value.product_name + "\")'>" +
                ...
                success: function(result) {
                    ...
                    for (var count = 0; count < result.length; count++) {
                        $("#tblgrn tbody").append(
                            ...
                            "<div class='rkmd-checkbox checkbox-rotate'>" +
                            "<label class='input-checkbox checkbox-primary'>" +
                            "<input type='checkbox' id='" + result[count].stock_id +
                            "' class='chkbx' onclick='chkbox(" + result[count].stock_id + ")'>" +
                            "<span class='checkbox'></span>" +
                            "</label>" +
                            "<div class='captions'></div>" +
                            "</td>" +
