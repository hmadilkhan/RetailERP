		...
		<tbody>
			...
			<tr>
				<td>
					<div class='rkmd-checkbox checkbox-rotate'>
						<label class='input-checkbox checkbox-primary'>
							<input type='checkbox' id='checkbox32{{$inventory->id}}' class='chkbx' onclick='chkbox("checkbox32{{$inventory->id}}")' data-id='{{$inventory->id}}'>
							<span class='checkbox'></span>
						</label>
						<div class='captions'></div>
					</div>
				...
				<td>
					<a href="{{ asset('assets/images/products/'.($inventory->product_image == '' ? '/placeholder.jpg' : $inventory->product_image))}}" data-toggle="lightbox"  data-footer=''>
					<img width="12" height="12" data-modal="modal-12" src="{{ asset('assets/images/products/'.($inventory->product_image == '' ? '/placeholder.jpg' : $inventory->product_image))}}" class='d-inline-block img-circle ' alt=''>
					</a>
				</td>
				...
				<td>{{($inventory->tax_rate == null ? 0.00 : $inventory->tax_rate)}}</td>
				...
				<td> 
				<a onclick='show_barcode("{{$inventory->item_code}}","{{$inventory->product_name}}","{{$inventory->retail_price}}")' class='p-r-10 f-18 text-success' data-toggle='tooltip' data-placement='top' title='Print Barcode' data-original-title='Barcode'><i class='icofont icofont-barcode'></i></a>
					<a onclick='edit_route("{{$inventory->slug}}")' class='p-r-10 f-18 text-warning' data-toggle='tooltip' data-placement='top' title='' data-original-title='Edit'><i class='icofont icofont-ui-edit'></i></a>
					<i class='icofont icofont-ui-delete text-danger f-18 ' onclick='deleteCall("{{$inventory->id}}")' data-id='value.id' data-toggle='tooltip' data-placement='top' title='' data-original-title='Delete'></i>
					&nbsp;<i onclick='assignToVendorModal("{{$inventory->id}}") class="icofont icofont icofont-business-man #3A6EFF" data-toggle='tooltip' data-placement='top' title='' data-original-title='Assign To Vendors'></i>
				</td>
			</tr>
			@endforeach
		</tbody>
