    ...
    <div class="card-block">
      ...
      <div class="row">
        ...
        <div class="button-group ">
          ...
          <button type="button" id="btnsubmit" class="btn btn-md btn-success waves-effect waves-light m-t-20 " onclick="submit()">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="action-icon">
              ...
              <a href="{{ url('/permission') }}/{{ Crypt::encrypt($value->terminal_id) }}" class="icofont icofont icofont-layout text-info f-18" data-id="{{ $value->terminal_id }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Permission"></a>

              <a href="{{ url('/printing-details') }}/{{ Crypt::encrypt($value->terminal_id) }}" class="icofont  icofont icofont-print text-success f-18" data-id="{{ $value->terminal_id }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Print Details"></a>

              <a href="{{ url('/bind-terminals') }}/{{ Crypt::encrypt($value->terminal_id) }}/{{ Crypt::encrypt($branch) }}" class="icofont  icofont icofont-at text-success f-18" data-id="{{ $value->terminal_id }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Bind Terminal"></a>
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6">
            ...
            <input type="text" name="terminalnamemodal" id="terminalnamemodal" class="form-control" />
