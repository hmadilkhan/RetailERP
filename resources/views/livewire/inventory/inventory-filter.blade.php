        ...
        {{-- <div class="card"> --}}
            <div class="card-header">
                ...
                <div class="button-group col-md-2 mt-2 f-left">
                    <div class="rkmd-checkbox checkbox-rotate">
                        <label class="input-checkbox checkbox-primary">
                            <input type="checkbox" id="Inactive" class="f-left" wire:model="inactiveChecked" wire:change="applyFilters()" wire:loading.attr="disabled">
                ...
                <div class="button-group col-md-2 mt-2 f-left">
                    <div class="rkmd-checkbox checkbox-rotate">
                        <label class="input-checkbox checkbox-primary">
                            <input type="checkbox" id="nonstock" class="f-left" wire:model="nonstockChecked" wire:change="applyFilters()" wire:loading.attr="disabled">
                            <span class="checkbox"></span>
                        </label>
                    ...
                    <div id="ddselect" class="dropdown-secondary dropdown  f-right" style="display: none;">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown6" data-dropdown-in="fadeIn"
                            ...
                            <a class="dropdown-item waves-light waves-effect" id="btn_change_tags" data-toggle="modal"
                                data-target="#tags-detail-modal"><i class="icofont icofont-company"></i>&nbsp;Link
                                Tags</a>
                            <div class="dropdown-divider"></div>
