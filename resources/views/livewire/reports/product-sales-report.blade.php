    ...
    <div class="card">
        ...
        <div class=" card-footer">
            <div class="d-flex gap-2 justify-content-end">
                ...
                <button class="btn btn-primary px-4" type="button" wire:click="generateReport" wire:load 
                    ...
                    <tbody>
                        ...
                        @forelse($results as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a target="_blank" href="{{ route('order.details', $row->receipt_id) }}" class="btn btn-sm btn-primary">
                        ...
                        @endforelse
                        <tr>
                            <td class="bg-dark text-white fw-bold" colspan="3">Total ({{ $totalCount }} items)
                            </td>
                            ...
                            <td class="bg-dark text-white fw-bold text-center" colspan="2">-</td>
                        </tr>
                    </tbody>
                </table>
            </div>
