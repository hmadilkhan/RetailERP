       ...
       <div class="card-block">
        ...
        {{ csrf_field() }}
           ...
           <div class="col-lg-3 col-md-3">
               <div class="form-group">
                  ...
                  <input class="form-control" type="text" 
                   name="branchname" id="branchname" value="{{ old('branchname') }}"  />
         ...
         <div class="row">
  		...
  		<button type="submit" id="btnsubmit" class="btn btn-md btn-success waves-effect waves-light f-right" > Create Branch </button>
