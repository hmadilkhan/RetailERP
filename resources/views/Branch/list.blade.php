    ...
    <section class="panels-wells">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ url('/createbranch') }}" class="btn btn-success waves-effect waves-light f-right d-inline-block">
                    <i class="icofont icofont-plus f-18 m-r-5"></i>Create Branch
                </a>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="action-icon">
                                    ...
                                    <a href="{{ url('/branch-emails') }}/{{ Crypt::encrypt($value->branch_id) }}"
                                        ...
                                        title="" data-original-title="Emails"><i
                                            class="icofont icofont-email"></i></a>
                                    ...
                                    <i class="icofont icofont-ui-delete text-danger f-18"
                                        ...
                                        data-id="{{ $value->branch_id }}" data-toggle="tooltip" data-placement="top"
                                        title="" data-original-title="Delete"></i>&nbsp;

                                    <a href="{{ url('/terminals') }}/{{ Crypt::encrypt($value->branch_id) }}"
                                        class="icofont icofont icofont-plus text-info f-18"
                                        data-id="{{ $value->branch_id }}" data-toggle="tooltip" data-placement="top"
                                        title="" data-original-title="Terminal"></a>
