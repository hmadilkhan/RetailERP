...
<div class="card">
     ...
     <div class="card-header">
         ...
         <h5 class=""><a href="{{ url('/branches') }}"><i class="text-success text-center icofont icofont-arrow-left p-r-20 f-18" data-toggle="tooltip" data-placement="top" title="" data-original-title="Back">Back to list</i></a></h5>
         </div>      
                    ...
                    <select name="company" id="company" data-placeholder="Select Company" class="form-control select2" >
                        ...
                        @if($company)
                          @foreach($company as $value)
                            <option {{$value->company_id == $details[0]->company_id ? 'selected="selected"' : '' }} value="{{ $value->company_id }}">{{ $value->name }}</option>
                          @endforeach
                        @endif
                    </select>
         ...
         <div class="row">
           <div class="col-lg-3 col-md-3">
               <div class="form-group">
                  ...
                  <input class="form-control" type="text" required="required" 
                   name="br_email" id="email" value="{{$details[0]->branch_email}}"/>
				</div>
              </div>
              <div class="col-lg-3 col-md-3">
               <div class="form-group">
                  ...
                  <input class="form-control" type="text" required="required" 
                   name="br_mobile" id="mobile" value="{{$details[0]->branch_mobile}}"   />
				</div>
              </div>
               <div class="col-lg-3 col-md-3">
               <div class="form-group">
                  ...
                  <input class="form-control" type="text" required="required" 
                   name="br_ptcl" id="ptcl" value="{{$details[0]->branch_ptcl}}"   />
				</div>
              </div>
			  <div class="col-lg-3 col-md-3">
                 <div class="form-group">
                    ...
                    <input class="form-control" type="text" 
                     name="br_code" id="code" value="{{$details[0]->code}}"   />
          ...
          <div class="row">
                     ...
                     <select multiple name="reportlist[]" id="report" data-placeholder="Select Company" class="form-control select2" >
                        ...
                        @if($reports)
                          @foreach($reports as $value)
                            <option {{ in_array($value->id, $branchreports->toArray()) ? 'selected="selected"' : '' }} value="{{ $value->id }}">{{ $value->name }}</option>
                          @endforeach
                        @endif
                     </select>
			...
			<div class="col-lg-2 col-md-2">
               <div class="form-group">
                  ...
                  <input class="form-control" type="text" 
                   name="report_send_date" id="report_send_date" value="{{$details[0]->report_send_date}}"   />
				</div>
              </div>
            <div class="col-lg-4 col-md-4">
			 ...
			 <div class="col-md-3" >
					<a href="#">
						<img id="vdpimg" src="{{ asset('storage/images/branch/'.(!empty($details[0]->branch_logo) ? $details[0]->branch_logo : 'placeholder.jpg').'') }}" class="thumb-img img-fluid width-100" alt="img" style="width: 128px;height: 128px;">
						</a>
                  ...
                  <input class="form-control" type="hidden" 
                   name="br_id" id="br_id" value="{{$details[0]->branch_id}}"/>
                   <input class="form-control" type="hidden" 
                   name="br_old_image" id="br_old_image" value="{{$details[0]->branch_logo}}"/>
          
  		<button type="submit" id="btnsubmit" class="btn btn-md btn-success waves-effect waves-light f-right" > Update Branch </button>
