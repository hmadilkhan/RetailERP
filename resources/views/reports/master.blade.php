...
@section('title','Master Payable')

@section('breadcrumtitle','Master Payable')

@section('navreports','active')
@section('navvendorreport','active')

@section('navmasterpay','active')
  ...
  <div class="card">
     <div class="card-header">
         ...
         <div class="row">
                ...
                <select name="master" id="master" data-placeholder="Select Master" class="form-control select2" >
...
<script type="text/javascript">
  ...
  {
    window.location = "{{url('masterpayable')}}?master="+$('#master').val()+"&first="+$('#from').val()+"&second="+$('#to').val();
