                        ...
                        <form method="get" action="{{ url('raw-usage-report') }}">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type='date' class="form-control" id="rpdate" name="from"
                                        placeholder="DD-MM-YYYY" required value="{{ $from }}" />
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type='date' class="form-control" id="date" name="to"
                                        placeholder="DD-MM-YYYY" required value="{{ $to }}" />
                            ...
                            <div class="col-md-2">
                                <div class="form-group mt-2">
                                    <button type="submit" class="btn btn-success text-white  mt-4"><i
                                            class="mdi mdi-check me-1"></i> Submit </button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="card border shadow-none">
                <div class="card-body">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#recipe-details" role="tab">
                                Item Wise Details
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#item-usage" role="tab">
                                Raw Items Usage
                            </a>
                        </li>
                        <li class="nav-item ms-auto">
                            <a href="{{ url('raw-usage-export?from='.$from.'&to='.$to) }}" class="btn btn-sm btn-success">
                    ...
                    <div class="tab-content p-3">
                        <div class="tab-pane active" id="recipe-details" role="tabpanel">
                            <div class="accordion" id="accordionExample">
                                @foreach ($totalSaleItems as $key => $item)
                                    <div class="accordion-item mt-2 bg-transparent">
                                        <h2 class="accordion-header" id="headingOne">
                                            <button id="collapsebutton{{ $key }}" class="accordion-button collapsed" type="button"
                                        ...
                                        <div id="collapse{{ $key }}" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                            ...
                                            <div class="accordion-body">
                                                <table class="table table-striped nowrap dt-responsive" width="100%">
                                                    ...
                                                    <tbody>
                                                        @php
                                                            $filteredArray = Arr::where($totalItemsArray, function ($value, $key) use (
                                                                $item,
                                                            ) {
                        ...
                        <div class="tab-pane" id="item-usage" role="tabpanel">
