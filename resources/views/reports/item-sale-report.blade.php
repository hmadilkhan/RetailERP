...
@section('title','Item Sale Report')

@section('breadcrumtitle','Item Sale Report')
		  ...
		  <div class="row dashboard-header m-l-2 m-t-2" id="totaldiv" style="display:none">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="card dashboard-product">
                     ...
                     <h2 class="dashboard-total-products">{{session('currency')}} <span id="totalamount"></span></h2>
   ...
   $("#branch").change(function(){
	...
	$("#btnExcel").click(function(){
		if($('input[name="fromdate"]').val() == '' && $('input[name="todate"]').val() == ''){
			...
			window.open("{{url('reports/excel-export-item-sale-report')}}"+"?fromdate="+$("#fromdate").val()+"&todate="+$("#todate").val()+"&branch="+$("#branch").val()+"&terminal="+$("#terminal").val()+"&customer="+$("#customer").val()+"&paymentmode="+$("#paymentmode").val()+"&ordermode="+$("#ordermode").val()+"&product="+$("#product_name").val()+"&type="+$("#report_type").val()+"&declaration="+$("#declaration").val()); 
		 }
	})
	...
	$("#btnPdf").click(function(){
		if($('input[name="fromdate"]').val() == '' && $('input[name="todate"]').val() == ''){
			...
			window.open("{{url('reports/pdf-export-item-sale-report')}}"+"?fromdate="+$("#fromdate").val()+"&todate="+$("#todate").val()+"&branch="+$("#branch").val()+"&terminal="+$("#terminal").val()+"&customer="+$("#customer").val()+"&paymentmode="+$("#paymentmode").val()+"&ordermode="+$("#ordermode").val()+"&product="+$("#product_name").val()+"&type="+$("#report_type").val()+"&declaration="+$("#declaration").val()); 
		 }
