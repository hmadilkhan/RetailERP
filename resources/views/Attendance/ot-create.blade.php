...
<div class="card">
     <div class="card-header">
         <h5 class="card-header-text">Create Over Time Formula</h5>
       ...
       <div class="card-block">
        <form method="post" action="{{url('/insert-ot')}}" id="upload_form" enctype="multipart/form-data">
        ...
        {{ csrf_field() }}
           ...
           <div class="col-lg-12 col-md-12">
               <div class="form-group {{ $errors->has('otformula') ? 'has-danger' : '' }} ">
                  ...
                  <input class="form-control" type="text" 
                   name="otformula" id="otformula" value="{{ old('otformula') }}"  />
     	...
     	<button type="submit" id="btnsubmit" class="btn btn-md btn-primary waves-effect waves-light f-right" > Submit OT Formula </button>
