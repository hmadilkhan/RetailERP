...
<div class="card">
     <div class="card-header">
         <h5 class="card-header-text">Create Office Shift</h5>
       ...
       <div class="card-block">
        <form method="post" action="{{url('/insert-shift')}}" id="upload_form" enctype="multipart/form-data">
        ...
        {{ csrf_field() }}
           ...
           <div class="col-lg-6 col-md-6">
               <div class="form-group {{ $errors->has('shiftname') ? 'has-danger' : '' }} ">
                  ...
                  <div class="rkmd-checkbox checkbox-rotate checkbox-ripple f-right">
                      ...
                      <div class="captions">For Different Date</div>
                    </div>
                  <input class="form-control" type="text" 
                   name="shiftname" id="shiftname" value="{{ old('shiftname') }}"  />
         ...
         <div class="row">
			...
			<!-- 	<input type="text" id="time" class="form-control floating-label" placeholder="Time"> -->
                  <input class="form-control" type="Time" 
                   name="shiftstart" id="shiftstart" value="{{ old('shiftstart') }}"  />
               ...
               <div class="form-group {{ $errors->has('shiftend') ? 'has-danger' : '' }} ">
                  ...
                  <input class="form-control" type="Time"
                   name="shiftend" id="shiftend" value="{{ old('shiftend') }}"  />
               ...
               <div class="form-group {{ $errors->has('gracetime') ? 'has-danger' : '' }} ">
                  ...
                  <input class="form-control" type="Number"
                   name="gracetime" id="gracetime" value="0"  />
               ...
               <div class="form-group {{ $errors->has('gracetimeearly') ? 'has-danger' : '' }} ">
                  ...
                  <input class="form-control" type="Number"
                   name="gracetimeearly" id="gracetimeearly" value="0"  />
                   <div class="form-control-feedback">Hint: Enter Minutes</div>
     	...
     	<button type="submit" id="btnsubmit" class="btn btn-md btn-primary waves-effect waves-light f-right" > Create Shift </button>
