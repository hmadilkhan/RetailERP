              ...
              @if($depart)
                @for($d=0;$d < sizeof($depart);$d++)
                       <tr>
                         ...
                         <td class="pointer" onclick="editdepart('{{ $depart[$d]->code }}','{{$depart[$d]->department_name}}','{{ $depart[$d]->website_department_name }}','{{$depart[$d]->department_id}}',{{ $depart[$d]->website_mode}},'{{ $depart[$d]->banner}}','{{ $depart[$d]->inventory_department_section->pluck("section_id")->implode(",")}}')">{{ $depart[$d]->code }}</td>
                         <td class="pointer" onclick="editdepart('{{ $depart[$d]->code }}','{{$depart[$d]->department_name}}','{{ $depart[$d]->website_department_name }}','{{$depart[$d]->department_id}}',{{ $depart[$d]->website_mode}},'{{ $depart[$d]->banner}}','{{ $depart[$d]->inventory_department_section->pluck("section_id")->implode(",")}}')">
                         ...
                         <td class="pointer" onclick="editdepart('{{ $depart[$d]->code }}','{{$depart[$d]->department_name}}','{{ $depart[$d]->website_department_name }}','{{$depart[$d]->department_id}}',{{ $depart[$d]->website_mode }},'{{ $depart[$d]->banner }}','{{ $depart[$d]->inventory_department_section->pluck("section_id")->implode(",")}}')">{{ $depart[$d]->department_name }}</td>
