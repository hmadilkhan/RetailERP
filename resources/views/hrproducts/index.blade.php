...
@section('title','HR Products')

@section('breadcrumtitle','HR Products')
                ...
                <div class="row">
					...
					<div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <div id="price_message" class="form-control-feedback text-danger"></div>
                        </div>
                    </div>
					<div class="col-lg-4 col-md-4">
		 ...
		 @if($lists)
            @foreach($lists as $value)
                    <tr>
                          ...
                          <td>{{$value->status}}</td>
						  <td>
							<a onclick='change_price("{{$value->id}}","{{$value->price}}")' class='p-r-10 f-18 text-success' data-toggle='tooltip' data-placement='top' title='Change Price' data-original-title='Barcode'><i class='icofont icofont-barcode'></i></a>
