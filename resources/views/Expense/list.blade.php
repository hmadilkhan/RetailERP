				...
				@foreach ($expense as $value)
					<tr>
						...
						@if(session("roleId") == 2 or session("roleId") == 1)
							...
							<i onclick="deleteExpense('{{ $value->exp_id }}')" class="text-danger text-center icofont icofont-ui-delete" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"></i>
							</td>
						@endif
					</tr>
				@endforeach
      ...
      <div class="modal-content">
       <!--  <form id="expcatform" method="POST" class="form-horizontal" action="">
         ...
         <div class="modal-footer">
            <button type="button" id="btn_depart" class="btn btn-success waves-effect waves-light" onClick="addExpCat()">Add Expense Category</button>
         </div>
      <!--  </form> -->
      </div>
   </div>
            ...
            for(var count = 0; count < result.length; count++){
				...
				$("#expensetb tbody").append(
					"<tr>" +
					  ...
					  "<td class='action-icon'>"+
						"<i onclick='deleteExpense("+result[count].exp_id+")' class='text-danger text-center icofont icofont-ui-delete' data-toggle='tooltip' data-placement='top' title='' data-original-title='Delete'></i>"+
					  "</td>"+  
					"</tr>"
				);
            }
