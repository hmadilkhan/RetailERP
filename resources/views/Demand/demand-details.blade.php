         ...
         <div class="card">
                 ...
                 <div class="f-right">
                     ...
                     @if (session('roleId') == 2)
                         @if ($details[0]->status1 == 'Pending')
                             <button class="icofont icofont-close fa-3x btn btn-warning btn-md f-right" data-toggle="tooltip"
                                 data-placement="top" title="" data-original-title="Reject Demand"
                                 onclick="update_demand_status()">Reject</button>

                             <button class="icofont icofont-truck-loaded fa-3x btn btn-info btn-md f-right"
                                 data-toggle="tooltip" data-placement="top" title="" data-original-title="Transfer"
                                 onclick="transfer('{{ $details[0]->doid }}')">Transfer</button>
                             <button class="icofont icofont-money-bag fa-3x btn btn-primary btn-md f-right"
                                 data-toggle="tooltip" data-placement="top" title="" data-original-title="Purchase"
                                 onclick="purchase('{{ $details[0]->doid }}')">Purchase</button>
                         @endif
                     @endif
                     <button class="icofont icofont-print fa-3x btn btn-danger btn-md f-right" data-toggle="tooltip"
                         data-placement="top" title="" data-original-title="Print"
                         onclick="generate_pdf()">Print</button>
                 </div>
             ...
             <div class="card-block">
                 ...
                 <div class="row invoive-info">
                     ...
                     <div class="col-md-4 col-sm-6">
                         <h6 class="m-b-20">Demand Number | <span>{{ $details == 0 ? '' : $details[0]->demand_id }}</span>
                         </h6>
                                         ...
                                         <tr>
                                             ...
                                             @if (session('roleId') == 2)
                                                 @if ($details[0]->status1 == 'In-Process' || $details[0]->status1 == 'Completed')
                                                     ...
                                                     <td><label>{{ $value->qty - $value->transfer_qty - $value->purchase_qty }}</label>
                                                     </td>
                                                 @endif
                                             @endif
             ...
             @if (session('roleId') == 2)
                 ...
                 <div class="row m-t-50">
                     <div class="radial">
                         <button class="icofont icofont-money-bag fa-3x" id="fa-2" data-toggle="tooltip"
                             data-placement="top" title="" data-original-title="Purchase"
                             onclick="purchase('{{ $details[0]->doid }}')"></button>

                         <button class="icofont icofont-print fa-3x" id="fa-3" data-toggle="tooltip"
                             data-placement="top" title="" data-original-title="Print"
                             onclick="generate_pdf()"></button>
                         <button class="icofont icofont-truck-loaded fa-3x" id="fa-4" data-toggle="tooltip"
                             data-placement="top" title="" data-original-title="Transfer"
                             onclick="transfer('{{ $details[0]->doid }}')"></button>
                         @if ($details[0]->status1 == 'Pending')
                             <button class="icofont icofont-close fa-3x" id="fa-1" data-toggle="tooltip"
                                 data-placement="top" title="" data-original-title="Reject Demand"
                                 onclick="update_demand_status()"></button>
                         @endif
                         <button class="fab">
                     ...
                     <div class="col-md-12">
                         <div class="form-group">
                             <div class="button-group ">
                                 <button type="button" id="btndraft" onclick="generate_pdf()"
                                     class="btn btn-md btn-danger waves-effect waves-light f-right m-r-20"> <i
