...
@section('content')
              ...
              <div class="card">
                ...
                <h3 class="card-header-text">Demand Details
                  ...
                  <a href="{{ url('/received-demand') }}" id="btnback" name="btnback"><i class="icofont icofont-arrow-left"></i>Back to List
                                    </a>
                  ...
                  <div class="card-block">
                     <div class="row invoive-info">
                        ...
                        <div class="col-md-4 col-sm-6">
                           <h6 class="m-b-20">Demand Number | <span id='demandid'>{{ $details == 0 ? '' : $details[0]->demand_id }}</span></h6>
                 ...
                 <tr>
                   ...
                   <td >{{$value->qty}}</td>
                   <td  >
                      <select class="select2 form-control" data-placeholder="Select Action" id="status{{$value->id}}" name="status" onchange=" changeselection(this.id, '{{$value->productid}}','{{$value->id}}','{{$value->item_code}}')">
      ...
      <div class="col-lg-12 col-sm-12 ">
            <div class="form-group ">
                <button type="button" id="btnFinalSubmit" class="btn btn-md btn-primary waves-effect waves-light  f-right" onclick="update_status()"  > <i class="icofont icofont-plus"> </i>
                  ...
                  $.ajax({
                        ...
                        success : function(resp){
                          ...
                          $.each(resp,function(index,value){
                            ...
                            $('#abc').append('<div class="col-xl-4 col-lg-4 grid-item"><div class="card"><div class="card-block txt-white bg-spark-chart"><div> <h5 class="d-inline-block" id="brnch'+count+'" data-id="'+value.branch_id+'" data-value="'+value.branch_name+'">Branch, '+value.branch_name+'</h5></div><div class="text-center"><h1 class="f-w-100 f-90" id="stockvalue'+count+'" >'+value.stock+'</h1><h5 class="txt-white bg-spark-chart" >Stock in Hand</h5></div></div><div class="card-block"><label>Enter Transfer Quantity:</label> <input type="text" placeholder="0" name="transferqty'+count+'" id="transferqty'+count+'" class="form-control" /><br><a id="btntransfer'+count+'"class="btn btn-md btn-dark waves-effect waves-light f-right m-r-35" onclick="insert_tranfer('+count+','+value.product_id+','+value.branch_id+')" >Make Transfer Order </a></div></div></div>')
                            count++;
                            }
                          });
                          }
                                       ...
                                       title: "Error Message",
                                        ...
                                        $.ajax({
                                                ...
                                                $('#btntransfer'+count).addClass("disabled");
                                                 let result = $("#stockvalue"+count).html() - $("#transferqty"+count).val();
