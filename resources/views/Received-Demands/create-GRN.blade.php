...
<div class="card">
                ...
                <h3 class="card-header-text">Good Receiving Note
                 ...
                 <tr>
                  ...
                  <td style="display: none;" > <label>{{$value->product_id}}</label> </td>
                   ...
                   <td ><label>{{number_format(($value->shipment_charges == "" ? 0 : $value->shipment_charges) + $value->cost_price,2)}}</label></td>
                   <td><input type="text" value="0" class="form-control" id="retailprice" name="retailprice"></td>
                   <td><input type="text" value="0" class="form-control" id="Wholesale" name="Wholesale"></td>
                    <td><input type="text" value="0" class="form-control" id="Discount" name="Discount"></td>
      ...
      <div class="col-lg-12 col-sm-12 ">
            <div class="form-group ">
                <button type="button" id="btnFinalSubmit" class="btn btn-md btn-primary waves-effect waves-light  f-right" onclick="submit()"  ><i class="icofont icofont-plus"></i>
                   Submit
                </button>
