...
@section('breadcrumtitle','View EOBI')
...
@section('content')
 ...
 <div class="card">
            <div class="card-header">
                <h5 class="card-header-text">Create EOBI</h5>
            </div>
    ...
    <div class="card">
     <div class="card-header">
         <h5 class="card-header-text">EOBI List</h5>
       ...
       <div class="card-block">
                <div class="rkmd-checkbox checkbox-rotate">
                    ...
                    <span class="checkbox"></span>
                     ...
                     <div class="captions">Show In-Active EOBI</div>
                  </div>
                  <br/>
                      <br/>
...
<script type="text/javascript">
	function submit()
	{
		...
		if($("#charges").val() == ""){
			$("#charges_message").html("Please enter amount.");
		}else{
			$.ajax({
				url: "{{url('/insert-eobi')}}",
				type: 'POST',
