    ...
    <section class="panels-wells">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <h5 class=""><a href="{{ url('/joborder') }}"><i
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4  col-sm-12">
                        <div class="form-group">
                            ...
                            <select class="select2 form-control" data-placeholder="Select Product" id="product"
                                name="product" onchange="getuom()">
                    ...
                    <div class="col-lg-2  col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" readonly="true" name="uom" placeholder="kg" id="uom"
                                class="form-control" />
                            <span class="help-block"></span>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2  col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" readonly="true" name="rate" placeholder="0" id="rate"
                                class="form-control" />
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="col-lg-2  col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" readonly="true" name="weight" placeholder="0" id="weight"
                                class="form-control" />
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="col-lg-2  col-sm-12">
                        <div class="form-group">
                            ...
                            <select class="select2 form-control" data-placeholder="Select DineIn" id="dinein"
                                name="dinein">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2  col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="Number" min="0" placeholder="0" name="itemqty" id="itemqty"
                                class="form-control" onchange="qty_change()" />
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <!-- price select box -->
                    <div class="col-lg-2  col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" readonly="true" placeholder="0" name="cost" id="cost"
                                class="form-control" />
                            <span class="help-block"></span>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-1  col-sm-12">
                        <div class="form-group">
                            <button type="button" id="btnSubmit"
                                class="btn btn-md btn-primary waves-effect waves-light m-t-25">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('name') ? 'has-danger' : '' }} ">
                            ...
                            <input type="Number" readonly="true" min="0"
                                value="{{ $details[0]->ingredients_cost }}" id="ic" name="ic"
                                class="form-control" />
                            @if ($errors->has('name'))
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('name') ? 'has-danger' : '' }} ">
                            ...
                            <input type="Number" min="0" value="{{ $details[0]->material_cost }}"
                                id="pc" name="pc" class="form-control" onchange="getInfraCost()" />
                            @if ($errors->has('name'))
                                <div class="form-control-feedback">Required field can not be blank.</div>
                            @endif
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('name') ? 'has-danger' : '' }} ">
                            ...
                            <input type="Number" min="0" id="infra" name="infra"
                                value="{{ $details[0]->infrastructure_cost }}" class="form-control"
                                onchange="getInfraCost()" />
                            @if ($errors->has('name'))
                                <div class="form-control-feedback">Required field can not be blank.</div>
                            @endif
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group {{ $errors->has('name') ? 'has-danger' : '' }} ">
                            ...
                            <input readonly="readonly" type="Number" value="{{ $details[0]->total_cost }}"
                                min="0" id="totalCost" name="totalCost" class="form-control" />
                            @if ($errors->has('name'))
                                <div class="form-control-feedback">Required field can not be blank.</div>
                            @endif
                        </div>
                ...
                <button type="button" id="btnFinalSubmit" class="btn btn-md btn-info f-right"> <i
                        class="icofont icofont-edit-alt f-18"> </i>Update Job Order</button>
                        ...
                        success: function(result) {
                            ...
                            $.ajax({
                                ...
                                success: function(result) {
                                    ...
                                    if (result == 2) {
                                        swal_alert("Error Message !",
                                            "Product already exists ", "error", false);
                ...
                success: function(result) {
                    ...
                    $.each(result, function(index, value) {
                        $("#item_table tbody").append(
                            ...
                            "<td class='action-icon'><i id='btn" + index +
                            "' onclick='updateItem(" + value.recipy_details_id + "," + value
                            .item_id + "," + value.mode_id + "," + value.usage_qty + "," + value
                            .cost + "," + value.used_in_dinein +
                            ")'  class='icofont icofont-ui-edit' data-toggle='tooltip' data-placement='top' title='' data-original-title='Edit'></i>" +
                            " &nbsp;" + "<i id='btn" + index + "' onclick='deleteItem(" + value
                            .recipy_details_id + "," + value.recipy_id +
