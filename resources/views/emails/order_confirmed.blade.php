...
<body>
    <div class="email-container">
        ...
        <div class="email-content">
            ...
            <p>We’re excited to inform you that we have received your advance payment for your order
                <strong>{{ $orderNumber }}</strong>, and it has now been confirmed!</p>
            ...
            <p>Your order is now confirmed and will be processed shortly. Once the processing is complete, we will send
                you another update with shipping details, including tracking information and the estimated delivery
                time.</p>
