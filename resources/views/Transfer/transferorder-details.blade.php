    ...
    <section class="panels-wells">
        <div class="card">
            ...
            <div class="card-header">
                ...
                <a href="{{ url('/trf_list') }}" id="btnback" name="btnback"><i class="icofont icofont-arrow-left"></i>Back to
                    List
                </a>
                <div class="f-right">
            ...
            <div class="card-block">
                <div class="row invoive-info">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <h6 class="m-b-20">Transfer Number |
                            <span>{{ $getdetails == 0 ? '' : $getdetails[0]->transfer_No }}</span>
                        </h6>
