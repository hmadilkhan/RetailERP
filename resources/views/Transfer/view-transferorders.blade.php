...
<section class="panels-wells">
    <div class="card">
     <div class="card-header">
         ...
         <a href="{{ url('create-transferorder') }}" class="btn btn-primary waves-effect waves-light f-right d-inline-block"> <i class="icofont icofont-plus f-18 m-r-5"></i>Create Transfer Order
              </a>
         </div>      
           ...
           @foreach($gettransfer as $value)
                 ...
                 <td class="action-icon">
                      ...
                      <i class="icofont icofont-eye-alt text-primary p-r-10 f-18"  data-toggle="tooltip" data-placement="top" title="" data-original-title="View" onclick="view('{{$value->transfer_id}}')" ></i>
                       ...
                       <a class="{{ $value->name == 'Delivered' ? 'disabled' : '' }} m-r-10" data-toggle="tooltip" data-placement="top" title="Edit Transfer Order" data-original-title="{{ $value->name == 'Delivered' ? 'Disabled' : 'Edit' }}"><i class="icofont icofont-ui-edit text-{{ $value->name == 'Delivered' ? 'muted' :'info'}} f-18"  <?php echo ($value->name == "Delivered" ?  '' : ' onclick="edit('.$value->transfer_id.')" '); ?>   ></i></a>
