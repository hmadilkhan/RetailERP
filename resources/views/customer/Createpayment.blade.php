  ...
  <section class="panels-wells">
    <div class="card">
      <div class="card-header"> 
        <h5 class="card-header-text">Customer Received Payment - {{$customerName}}</h5>
        <h5 class=""><a href="{{ url('ledgerDetails',$slug) }}"><i class="text-primary text-center icofont icofont-arrow-left p-r-20 f-18" data-toggle="tooltip" data-placement="top" title="" data-original-title="Back">Back to List</i></a></h5>
      </div>
          ...
          @if($customerAdvance > 0)
             <div class="col-lg-2 col-sm-2 col-xs-2">
               <div class="form-group">
                 ...
                 <input disabled="" type="text" id="advance_payment" class="form-control"  value="{{$customerAdvance}}" name="advance_payment" >
                </div>
          </div>
          @endif
           <div class="col-lg-2 col-sm-2 col-xs-2">
           ...
           <div class="col-lg-2 col-sm-2 col-xs-2">
               <div class="form-group">
                  ...
                  <input type='text' onkeypress="return isNumberKey(event)" class="form-control" id="debit" name="debit" placeholder="Enter Received Amount Here"/>
                  <span class="help-block text-danger" id="dbox"></span>
                </div>
          </div>
            <div class="col-lg-2 col-sm-2 col-xs-2">
...
// console.log("Array respone: "+car);
   ...
   $('#debit').change(function(){
    ...
    if(mode == 1){
   		...
   		$("#item tbody tr ").each(function(k){
			...
			console.log("Checking Mode",selectedReceiptId); 
			$('#amtlbl'+selectedReceiptId).html(parseFloat($('#debit').val())); 
		}
   });
  ...
  $('#btnSubmit').click(function(e){
    ...
    // if(Number(debit) > Number(totalCredit))
    // {
    //   swal({
    //         title: "Error",
            ...
            {{--}else{--}}
                if (id == undefined) {
                    ...
                    $("#item tbody tr ").each(function (k) {
                        ...
                        console.log("Cash Manual Run" + id + "---"+paidamt)
                        ...
                        addPayment(id, netamt, paidamt, totalCredit, cashBalance,$('#payMethod').val(),ledgerEntries)
                    });
                }
                ...
                swal({
                    ...
                    if (id == undefined) {
                        ...
                        $("#item tbody tr ").each(function (k) {
                            ...
                            console.log("hERE Bank Manual Run" + id)
                            netamt = netamt.replace(/\,/g, '');
  ...
  function addPayment(id,net,bal,credit,bankBalance,mode,ledgerEntries = true)
  {
	console.log(net)
    var status ;
    var amount;
                     ...
                     if (resp > 0) {
                         ...
                         swal({
                             ...
                             if (isConfirm) {
                                 ...
                                 // location.reload();
                                 window.location="{{ url('ledgerDetails',$slug) }}";
                             }
                         });
                     } else {
