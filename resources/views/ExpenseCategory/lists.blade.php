...
Expense Category" class="form-control " />
                ...
                <div class="col-lg-1 ">
                  <button type="button" id="btn_save"  class="btn btn-success btn-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Create Category" style="margin-top: 30px;"> <i class="icofont icofont-plus"
         ...
         <tbody>
            ...
            <tr> 
               ...
               <td class="action-icon">
                  <i onclick="edit_record('{{ $value->exp_cat_id }}')" class="text-success text-center icofont icofont-ui-edit" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"></i>
               </td>        
           </tr>
             	@endforeach
            @endif
                                  ...
                                  if (inputValue === "") {
                                    ...
                                    return false
                                         ...
                                         $.ajax({
                                            ...
                                            type:"PUT",
                                            data:{_token:"{{ csrf_token() }}",id:r[0].id,cat:inputValue},
                                            dataType:"json",
                                            success:function(r){
                                     
                                             if(r.state == 1){
                                                 var message = "Category '"+inputValue +"' updated Successfully !"; 
                                                 swal_alert('Success!',message,'success',true);
                                                
                                             }else {
                                              var message = "Category '"+inputValue +"' already exists !"; 
                                                 swal_alert('Alert!',message,'error',false);
                                             }
                                           }
                                        });         
