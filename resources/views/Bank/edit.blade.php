    ...
    <section class="panels-wells">
        <div class="card">
            ...
            <div class="card-block">
                <form method="post" action="{{url('update-bank')}}" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    <div class="row">
                        <input type="hidden" value="{{$getBank[0]->image}}" name="prev_image">
                        <input type="hidden" value="{{$getBank[0]->bank_id}}" name="id">
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group">
                                <label class="form-control-label">Bank Name</label>
                                <input class="form-control" type="text" required="required" name="bankname" id="bankname" value="{{$getBank[0]->bank_name}}"   />
                            </div>
                        </div>
                        <div class="col-md-4" >
                            <a href="#">
                        ...
                        <button type="submit" id="btnsubmit" class="btn btn-md btn-primary waves-effect waves-light f-right"> Edit Bank </button>
                    </div>
                </form>
            </div>
        </div>
