    ...
    <div class="card" style="border: 0; overflow: hidden; box-shadow: 0 18px 40px rgba(32, 56, 85, 0.12);">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <div>
                    <h5 class="card-header-text m-b-5">Invoice Setup List</h5>
                    <p class="text-muted m-b-0">Manage billing setup rules and jump directly to each company invoice history.</p>
                </div>
        ...
        <div class="card-block" style="background: linear-gradient(180deg, #fbfcfe 0%, #f4f7fb 100%);">
            ...
            <div class="table-responsive" style="border-radius: 16px; overflow: hidden; box-shadow: 0 12px 35px rgba(30, 54, 80, 0.08);">
                <table class="table table-bordered table-hover m-b-0" style="background: #fff;">
                    <thead style="background: linear-gradient(90deg, #17324d 0%, #264f73 100%); color: #fff;">
                        <tr>
