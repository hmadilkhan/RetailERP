...
<section class="panels-wells">
    <div class="card">
     <div class="card-header">
         ...
         <a href="{{route('company.create')}}" class="btn btn-primary waves-effect waves-light f-right d-inline-block"> <i class="icofont icofont-plus f-18 m-r-5"></i>Create Company
              </a>
              ...
              @foreach($company as $value)
                    <tr>
                         ...
                         <td class="text-center">
                                 <img width="42" height="42" src="{{ asset('storage/images/company/'.(!empty($value->logo) ? $value->logo : 'placeholder.jpg').'') }}" class="d-inline-block img-circle " alt="{{ !empty($value->logo) ? $value->logo : 'placeholder.jpg' }}">
                          </td>
                          <td>{{$value->name}}</td>
                          ...
                          <td class="action-icon">
                                ...
                                <a href="{{ url('/company-edit') }}/{{ $value->company_id }}" class="p-r-10 f-18 text-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a>
