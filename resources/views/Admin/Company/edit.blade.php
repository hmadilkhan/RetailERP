    ...
    <section class="panels-wells">
        <div class="card">
            ...
            <div class="card-block">
                <form method="post" action="{{ route('company.update', $company[0]->company_id) }}" class="form-horizontal"
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4">
                            ...
                            <input type="hidden" name="pos_bg_logo" id="pos_bg_logo"
                                value="{{ $company[0]->pos_background }}">
                            <input type="hidden" name="prev_order_calling_display" id="pos_bg_logo"
                                value="{{ $company[0]->order_calling_display_image }}">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group {{ $errors->has('company_mobile') ? 'has-danger' : '' }}">
                                ...
                                <input class="form-control" type="text" name="company_mobile" id="company_mobile"
                                    value="{{ $company[0]->mobile_contact }}" />
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group {{ $errors->has('whatsapp_number') ? 'has-danger' : '' }}">
                                ...
                                <input class="form-control" type="text" name="whatsapp_number" id="whatsapp_number"
                                    value="{{ old('whatsapp_number', $company[0]->whatsapp_number ?? '') }}" />
