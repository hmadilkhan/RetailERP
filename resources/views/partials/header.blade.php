            ...
            <div class="navbar-custom-menu">
              ...
              <!--
                  <li class="dropdown notification-menu">
                    ...
                    <img class="img-circle" src="{{ asset('assets/images/users/avatar-1.png') }}" alt="User Image">
                  </span>
                  ...
                  <li class="dropdown">
                     <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image">
                        <span><img class="img-circle " src="{{ asset('assets/images/users/'.(session('image') == '' ? 'person-placeholder.png' : session('image')) ) }}" style="width:40px;" alt="User Image"></span>
