   ...
   <link rel="shortcut icon" href="{{ asset('storage/images/favicon.jpg') }}" type="image/x-icon">-->
    ...
    <!-- Date Picker css -->
    <link rel="stylesheet"
        href="{{ asset('components/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css') }}" />

    <!-- Bootstrap Date-Picker css -->
    <link rel="stylesheet"
        href="{{ asset('assets/plugins/bootstrap-datepicker/css/bootstrap-datetimepicker.css') }}" />
    <link rel="stylesheet" type="text/css"
        href="{{ asset('components/bootstrap-daterangepicker/daterangepicker.css') }}" />
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('components/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css') }}">
    ...
    <link type="text/css" rel="stylesheet"
        href="{{ asset('components/syntaxhighlighter/styles/shCoreDjango.css') }}" />
