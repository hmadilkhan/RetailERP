    ...
    <section class="panels-wells p-t-3">
                            ...
                            <select name="website" id="website" data-placeholder="Select" class="form-control select2">
                                ...
                                @if ($websiteLists)
                                    ...
                                    @foreach ($websiteLists as $val)
                                        <option {{ $oldWebsite == $val->id ? 'selected' : '' }} value="{{ $val->id }}">
                                            {{ $val->name }}</option>
                                    @endforeach
                                @endif
                            </select>
        ...
        @if ($GetWebsite != null)
            ...
            <div class="card card-block">
                <form name="themeSetting" method="post" action="{{ route('webSetSaveChanges') }}"
                        ...
                        <div class="tab-pane active" id="home" role="tabpanel">
                            <div class="col-md-6 m-t-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Message"
                                            aria-describedby="btn-page_title" data-id="website"
                                            value="{{ stripslashes($GetWebsite->page_title) }}" name="page_title"
                                            id="page_title">
                                        <span class="input-group-btn" id="btn-page_title"><button type="button"
                                                onclick="btn_update('page_title')"
                                                class="btn btn-primary shadow-none addon-btn waves-effect waves-light">Update!</button></span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Message"
                                            aria-describedby="btn-meta_title" data-id="website"
                                            value="{{ $GetWebsite->meta_title }}" name="meta_title" id="meta_title">
                                        <span class="input-group-btn" id="btn-meta_title"><button type="button"
                                                onclick="btn_update('meta_title')"
                                                class="btn btn-primary shadow-none addon-btn waves-effect waves-light">Update!</button></span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" onclick="btn_update('meta_description')"
                                        class="btn btn-primary shadow-none waves-effect waves-light m-t-1">Update!</button>
                                    <span id="meta_description_alert"></span>
                                </div>

                                <div class="form-group">
                                    <label for="depart_nav_layout" class="form-control-label">Department Navigation Bar
                                        Style</label>
                                    <select name="depart_nav_layout" id="depart_nav_layout" data-placeholder="Select"
                                        class="form-control select2"
                                        onchange="update('depart_nav_layout',$(this).val(),'theme')">
                                        @php
                                            $olddepart_nav_layout = old('depart_nav_layout')
                                                ? old('depart_nav_layout')
                                                : $GetWebsite->depart_nav_layout;
                                        @endphp
                                        <option value="">Select</option>
                                        <option {{ $olddepart_nav_layout == 1 ? 'selected' : '' }} value="1">UnderLine
                                            Navigate</option>
                                        <option {{ $olddepart_nav_layout == 2 ? 'selected' : '' }} value="2">Box
                                            Navigate</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="fonts" id="fonts" data-placeholder="Select"
                                        class="form-control select2" onchange="update('fontstyle',$(this).val(),'theme')">
                                        @php
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cart_layout" id="cart_layout" data-placeholder="Select"
                                        class="form-control select2"
                                        onchange="update('cart_layout',$(this).val(),'theme')">
                                        @php
                                            $oldcart_layout = old('cart_layout')
                                                ? old('cart_layout')
                                                : $GetWebsite->cart_layout;
                                        @endphp
                                        <option value="">Select</option>
                                        <option {{ $oldcart_layout == '1' ? 'selected' : '' }} value="1">Fixed Cart
                                        </option>
                                        <option {{ $oldcart_layout == '2' ? 'selected' : '' }} value="2">Drawer Cart
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-6 m-t-3">
                                <div class="form-group">
                                    ...
                                    <label>
                                        ...
                                        @endphp
                                        <input type="checkbox" id="topbar_mode"
                                            onchange="changeCheckbox('topbar_mode',{{ $GetWebsite->id }},'website')"
                                            value="{{ !empty($topbar_mode) ? 1 : 0 }}"
                                            {{ !empty($topbar_mode) ? 'checked' : '' }} data-toggle="toggle">
                                    </label>
                                </div>
                                ...
                                <div class="form-group {{ !empty($topbar_mode) ? '' : 'd-none' }}" id="topbarInput">
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="TopBar Message"
                                            aria-describedby="btn-topbar" data-id="website"
                                            value="{{ $GetWebsite->topbar }}" id="topbar" name="topbar">
                                        <span class="input-group-btn" id="btn-topbar"><button type="button"
                                                onclick="btn_update('topbar')"
                                                class="btn btn-primary shadow-none addon-btn waves-effect waves-light">Update!</button></span>
                                    </div>
                                ...
                                <div class="form-group" id="topbarSlideMsgInput">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="TopBar Slide Message"
                                            aria-describedby="btn_topbar_slide_msg" data-id="website" value=""
                                            id="topbar_slide_msg" name="topbar_slide_msg">
                                        <span class="input-group-btn" id="btn_topbar_slide_msg"><button type="button"
                                                onclick="btn_update('topbar_slide_msg')"
                                                class="btn btn-primary shadow-none addon-btn waves-effect waves-light">Update!</button></span>
                                    </div>
                        ...
                        <div class="tab-pane" id="contact" role="tabpanel">
                            <div class="col-md-6 m-t-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Message"
                                            aria-describedby="btn-whatsapp" data-id="website"
                                            value="{{ $GetWebsite->whatsapp }}" name="whatsapp" id="whatsapp">
                                        <span class="input-group-btn" id="btn-whatsapp"><button type="button"
                                                onclick="btn_update('whatsapp')"
                                                class="btn btn-primary shadow-none addon-btn waves-effect waves-light">Update!</button></span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Message"
                                            aria-describedby="btn-uan_number" data-id="website"
                                            value="{{ $GetWebsite->uan_number }}" name="uan_number" id="uan_number">
                                        <span class="input-group-btn" id="btn-uan_number"><button type="button"
                                                onclick="btn_update('uan_number')"
                                                class="btn btn-primary shadow-none addon-btn waves-effect waves-light">Update!</button></span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="email" class="form-control" placeholder="Email"
                                            aria-describedby="btn-email" data-id="website"
                                            value="{{ $GetWebsite->email }}" name="email" id="email">
                                        <span class="input-group-btn" id="btn-email"><button type="button"
                                                onclick="btn_update('email')"
                                                class="btn btn-primary shadow-none addon-btn waves-effect waves-light">Update!</button></span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" onclick="btn_update('address')"
                                        class="btn btn-primary shadow-none addon-btn waves-effect waves-light m-t-1">Update!</button>
                        ...
                        <div class="tab-pane" id="product" role="tabpanel">
                            ...
                            <div class="col-md-6 m-t-3">
                                <div class="form-group">
                                    ...
                                    <select name="product_view" id="product_view" data-placeholder="Select"
                                        class="form-control select2"
                                        onchange="update('product_view',$(this).val(),'theme')">
                                        @php
                                            $oldproduct_view = old('product_view')
                                                ? old('product_view')
                                                : $GetWebsite->product_view;
                                        @endphp
                                        <option value="">Select</option>
                                        <option {{ $oldproduct_view == 'modal_view' ? 'selected' : '' }}
                                            value="modal_view">Modal View</option>
                                        <option {{ $oldproduct_view == 'page_view' ? 'selected' : '' }} value="page_view">
                                            Page View</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="product_list" id="product_list" data-placeholder="Select"
                                        class="form-control select2"
                                        onchange="update('product_list',$(this).val(),'theme')">
                                        @php
                                            $oldproduct_list = old('product_list')
                                                ? old('product_list')
                                                : $GetWebsite->product_list;
                                        @endphp
                                        <option value="">Select</option>
                                        <option {{ $oldproduct_list == 1 ? 'selected' : '' }} value="1">Landscape
                                        </option>
                                        <option {{ $oldproduct_list == 2 ? 'selected' : '' }} value="2">Vertical
                                        </option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="location_modal" id="location_modal" data-placeholder="Select"
                                        class="form-control select2"
                                        onchange="update('location_modal',$(this).val(),'theme')">
                                        @php
                                            $oldlocation_modal = old('location_modal')
                                                ? old('location_modal')
                                                : $GetWebsite->location_modal;
                                        @endphp
                                        <option value="">Select</option>
                                        <option {{ $oldlocation_modal == 0 ? 'selected' : '' }} value="0">After
                                        </option>
                                        <option {{ $oldlocation_modal == 1 ? 'selected' : '' }} value="1">Start up
                                        </option>
                                    </select>
                        ...
                        <div class="tab-pane" id="website-logo" role="tabpanel">
                            ...
                            <div class="col-md-6 m-t-3">
                                <div class="form-group">
                                    ...
                                    @php
                                        $lightLogo = !empty($GetWebsite->logo)
                                            ? 'website/' . $GetWebsite->logo
                                            : 'placeholder.jpg';
                                    @endphp
                                    <img id="logoimages" src="{{ asset('storage/images/' . $lightLogo) }}"
                                        class="thumb-img img-fluid width-100" alt="img"
                                        style="width: 128px;height: 128px;">
                                    <br />
                                    <label for="logo" class="custom-file">
                                        <input type="file" name="logo" id="logo"
                                            onchange="readURL(this,'logoimages')" class="custom-file-input">
                                ...
                                <div class="form-group">
                                    ...
                                    @php
                                        $darkLogo = !empty($GetWebsite->dark_logo)
                                            ? 'website/' . $GetWebsite->dark_logo
                                            : 'placeholder.jpg';
                                    @endphp
                                    <img id="dark_logoimages" src="{{ asset('storage/images/' . $darkLogo) }}"
                                        class="thumb-img img-fluid width-100" alt="img"
                                        style="width: 128px;height: 128px;">
                                    <br />
                                    <label for="dark_logo" class="custom-file">
                                        <input type="file" name="dark_logo" id="dark_logo"
                                            onchange="readURL(this,'dark_logoimages')" class="custom-file-input">
                                        <span class="custom-file-control"></span>
                                    </label>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @php
                                        $favicon = !empty($GetWebsite->favicon)
                                            ? 'website/' . $GetWebsite->favicon
                                            : 'placeholder.jpg';
                                    @endphp
                                    <img id="faviconimages" src="{{ asset('storage/images/' . $favicon) }}"
                                        class="thumb-img" alt="img" style="width: 32px;height: 32px;">
                                    <br />
                                    <label for="favicon" class="custom-file">
                                        <input type="file" name="favicon" id="favicon"
                                            onchange="readURL(this,'faviconimages')" class="custom-file-input">
                                        <span class="custom-file-control"></span>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="footer" role="tabpanel">
                            <div class="col-md-6 m-t-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="footer_layout" id="footer_layout" data-placeholder="Select"
                                        class="form-control select2"
                                        onchange="update('footer_layout',$(this).val(),'theme')">
                                        @php
                                            $oldfooter_layout = old('footer_layout')
                                                ? old('footer_layout')
                                                : $GetWebsite->footer_layout;
                                            $footerLayoutArray = [1, 2];
                                        @endphp
                                        <option value="">Select</option>
                                        @foreach ($footerLayoutArray as $val)
                                            <option {{ $oldfooter_layout == $val ? 'selected' : '' }}
                                                value="{{ $val }}">Layout {{ $val }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6 m-t-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <label>
                                        ...
                                        @endphp
                                        <input id="is_open"
                                            onchange="changeCheckbox('is_open',{{ $GetWebsite->id }},'website')"
                                            type="checkbox" {{ $is_open == 1 ? 'checked' : '' }} data-toggle="toggle">
                                    </label>

                                    <div class="input-group {{ $is_open == 1 ? 'd-none' : '' }}" id="closingInput">
                                        <input type="text" class="form-control" placeholder="Message"
                                            aria-describedby="btn-closing_msg" data-id="website"
                                            value="{{ !empty($closing_msg) ? $closing_msg : 'Sorry! We are closed right now' }}"
                                            id="closing_msg" name="closing_msg">
                                        <span class="input-group-btn" id="btn-closing_msg"><button type="button"
                                                onclick="btn_update('closing_msg')"
                                                class="btn btn-primary shadow-none addon-btn waves-effect waves-light">Update!</button></span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label>
                                        ...
                                        <input id="maintenance_mode"
                                            onchange="changeCheckbox('maintenance_mode',{{ $GetWebsite->id }},'website')"
                                            type="checkbox" {{ $maintenance_mode == 1 ? 'checked' : '' }}
                                            data-toggle="toggle">
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label>
                                        ...
                                        @endphp
                                        <input id="checkout_otp"
                                            onchange="changeCheckbox('checkout_otp',{{ $GetWebsite->id }},'theme')"
                                            type="checkbox" {{ $checkout_otp == 1 ? 'checked' : '' }}
                                            data-toggle="toggle">
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label>
                                        ...
                                        @endphp
                                        <input id="otp_whatsapp_msg"
                                            onchange="changeCheckbox('otp_whatsapp_msg',{{ $GetWebsite->id }},'theme')"
                                            type="checkbox" {{ $otp_whatsapp_msg == 1 ? 'checked' : '' }}
                                            data-toggle="toggle">
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label>
                                        ...
                                        @endphp
                                        <input id="otp_msg"
                                            onchange="changeCheckbox('otp_msg',{{ $GetWebsite->id }},'theme')"
                                            type="checkbox" {{ $otp_msg == 1 ? 'checked' : '' }} data-toggle="toggle">
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label>
                                        ...
                                        @endphp
                                        <input id="top_contact_box"
                                            onchange="changeCheckbox('top_contact_box',{{ $GetWebsite->id }},'theme')"
                                            type="checkbox" {{ $top_contact_box == 1 ? 'checked' : '' }}
                                            data-toggle="toggle">
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label>
                                        ...
                                        @endphp
                                        <input id="back_to_top_btn"
                                            onchange="changeCheckbox('back_to_top_btn',{{ $GetWebsite->id }},'theme')"
                                            type="checkbox" {{ $back_to_top_btn == 1 ? 'checked' : '' }}
                                            data-toggle="toggle">
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label>
                                        ...
                                        <input type="checkbox" id="advertisement"
                                            onchange="changeCheckbox('advertisement',{{ $GetWebsite->id }},'theme')"
                                            value="{{ !empty($advertisement_mode) ? 1 : 0 }}"
                                            {{ !empty($advertisement_mode) ? 'checked' : '' }} data-toggle="toggle">
                                    </label>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Message"
                                            aria-describedby="btn-order_estimate_time" data-id="website"
                                            value="{{ $GetWebsite->order_estimate_time }}" name="order_estimate_time"
                                            id="order_estimate_time">
                                        <span class="input-group-btn" id="btn-order_estimate_time"><button type="button"
                                                onclick="btn_update('order_estimate_time')"
                                                class="btn btn-primary shadow-none addon-btn waves-effect waves-light">Update!</button></span>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="form-control-label">Rebuild Website</label>
                                    <br />
                                    <label>
                                        @php
                                            $advertisement_mode = $GetWebsite->advertisement;
                                        @endphp
                                        <a type="submit" id="advertisement"
                                            href="{{ route('rebuild', $GetWebsite->id) }}"
                                            class="btn btn-primary shadow-none addon-btn waves-effect waves-light">Rebuild
                                            Now</a>
                                    </label>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"
                            onclick="branchModalClose({{ $webId }})" aria-label="Close">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect waves-light"
                            onclick="branchModalClose({{ $webId }})" data-dismiss="modal">Close</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                success: function(resp) {
                    if (resp != '') {
                        ...
                        $.each(resp, function(i, v) {
                            ...
                            var checkBox_input =
                                '<label><input class="branchCheckBox" onclick="branch_isOpen(' + v.id +
                                ',' + id + ',$(this))" type="checkbox" ' + isChecked +
                                ' data-toggle="toggle"></label>';

                            $("#md_tbl_branch tbody").append('<tr><td>' + v.branch_name + '</td><td>' +
                                checkBox_input + '</td></tr>')
                        })
                    }
                }
            });
