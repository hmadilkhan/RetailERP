...
<div class="card">
    ...
    <form role="form" class="form-inline" method="POST" action="{{ route('sliderStore') }}" enctype="multipart/form-data">
		@csrf 
			<div class="form-group m-r-2">
                ...
                <button class="btn btn-primary m-l-3 m-t-1" type="submit">Add</button>
              </form> 
