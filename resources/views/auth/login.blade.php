                            ...
                            <form class="restyle2020-form" action="{{ route('login') }}" method="post">
                                ...
                                <div class="ui-form__section">
                                    ...
                                    <div class="next-input-wrapper">
                                        ...
                                        <input autofocus="autofocus" placeholder="Enter Username" class="next-input"
                                            size="30" type="text" name="username" id="username" />
                                    </div>
                                    <div class="next-input-wrapper">
                                        <label class="next-label" for="Password">Password</label>
                                        <input autofocus="autofocus" placeholder="Enter Password" class="next-input"
                                            size="30" type="password" name="password" id="password" />
                                    </div>

                                </div>
                                <button class="ui-button ui-button--primary ui-button--size-large"
                                    style="width: 100%;background-color: #4CAF50" type="submit">Login</button>
                            </form>
