...
<style>
    ...
    .category-neutral .category-amount {
        color: #667eea;
    }
    ...
    .summary-closing.balanced {
        border-left: 4px solid #10b981;
    }

    .summary-closing.unbalanced {
    ...
    .category-header.category-revenue i.mdi-trending-up {
        color: #10b981;
    }

    .category-header.category-deduction i.mdi-trending-down {
        color: #ef4444;
    }

    .category-header.category-neutral i.mdi-cash-plus {
        color: #667eea;
    }
</style>