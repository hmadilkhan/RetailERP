    ...
    <div class="col-md-12 mt-2">
        <div class="text-center text-primary">
            <span class="tag tag-success f-left f-24 m-20" style="margin-left:20px;cursor:pointer;"
                ...
                Sales</span>
            <span id="status"
                class="tag tag-{{ isset($heads[0]->status) && $heads[0]->status == 2 ? 'danger' : 'success' }} f-right m-20 f-24">
            ...
            @if (isset($heads[0]->closingBal) && $heads[0]->closingBal == 0)
                @if (isset($result[0]->ob) && $result[0]->ob == 0)
                    <span class="tag tag-danger f-24 m-20" style="cursor:pointer"
            ...
            @else
                @if (isset($result[0]->cb) && $result[0]->cb == 0)
                    <span class="tag tag-success f-24 m-20" style="cursor:pointer"
    ...
    <div class=" col-xl-12 dashboard-header m-l-10 ">
        <div class="col-lg-4 col-md-4">
            <div class="card tilebox-one">
                <div class="card-body">
                    ...
                    <h6 class="text-muted text-uppercase mt-0">OPENING</h6>
                    <h2>{{ session('currency') }} {{ number_format(isset($heads[0]->bal) ? $heads[0]->bal : 0, 0) }}
                    </h2>
                    <span class="badge bg-primary me-2"> Opening Date : </span> <span
                        class="text-muted">{{ date('d M Y', strtotime($heads[0]->date)) . ' ' . date('h:i A', strtotime($heads[0]->time)) }}</span>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4">
        ...
        <div class="col-lg-4 col-md-4">
            <div class="card tilebox-one">
                <div class="card-body">
                    <i class="dripicons-basket float-end text-muted"></i>
                    <h6 class="text-muted text-uppercase mt-0">CLOSING</h6>
            ...
            <div class="card">
                <div class="row">
                    <div class="col-sm-12 d-flex">
                        ...
                        <div class="col-sm-12">
                            <div class="">
                                <h3 id="takeaway" class="txt-warning f-34 clock">{{ session('currency') }}
            ...
            <div class="card">
                <div class="row">
                    <div class="col-sm-12 d-flex">
                        ...
                        <div class="col-sm-12">
                            <div class="">
                                <h3 id="delivery" class="txt-warning clock f-34">{{ session('currency') }}
        ...
        <table class="table table-responsive nowrap table-bordered table-striped nowrap dt-responsive m-t-10 dataTable no-footer dtr-inline">
            @if (isset($result[0]->ob) && $result[0]->ob == 1)
                <tr id="ob">
                    ...
                    <td id="opening" style="width:500px">{{ session('currency') }}
            ...
            @if (isset($result[0]->cash_sale) && $result[0]->cash_sale == 1)
                <tr id="cash_sale"
                    ...
                    <td id="cashSales" style="width:500px">{{ session('currency') }}
            ...
            @if (isset($result[0]->card_sale) && $result[0]->card_sale == 1)
                <tr id="card_sale"
                    ...
                    <td id="creditCard" style="width:500px">{{ session('currency') }}
            ...
            @if (isset($result[0]->customer_credit_sale) && $result[0]->customer_credit_sale == 1)
                <tr id="customer_credit_sale"
                    ...
                    <td id="customerCredit" style="width:500px">{{ session('currency') }}
            ...
            <tr class="f-24 form-control-label">
                ...
                <td id="Sales" style="width:500px">{{ session('currency') }}
            ...
            @if (isset($result[0]->cost) && $result[0]->cost == 1)
                <tr id="cost">
                    ...
                    <td id="totalCost" style="width:500px">{{ session('currency') }}
            ...
            @if (isset($result[0]->r_cash) && $result[0]->r_cash == 1)
                <tr id="r_cash">
                    ...
                    <td id="cashReturn" style="width:500px">{{ session('currency') }}
            ...
            @if (isset($result[0]->r_card) && $result[0]->r_card == 1)
                <tr id="r_card">
                    ...
                    <td id="cardReturn" style="width:500px">{{ session('currency') }}
            ...
            @if (isset($result[0]->r_cheque) && $result[0]->r_cheque == 1)
                <tr id="r_cheque">
                    ...
                    <td id="chequeReturn" style="width:500px">{{ session('currency') }}
            ...
            @if (isset($result[0]->sale_return) && $result[0]->sale_return == 1)
                <tr id="sale_return" style="cursor: pointer;"
                    ...
                    <td id="salesReturn" style="width:500px">{{ session('currency') }}
            ...
            @if (isset($result[0]->void_receipt) && $result[0]->void_receipt == 1)
                <tr id="discounthead">
                    ...
                    <td id="void_receipt" style="width:500px">{{ session('currency') }}
            ...
            @if (isset($result[0]->discount) && $result[0]->discount == 1)
                <tr id="discounthead">
                    ...
                    <td id="discount" style="width:500px">{{ session('currency') }}
            ...
            @if (isset($result[0]->cash_in) && $result[0]->cash_in == 1)
                <tr id="cash_in" style="cursor: pointer;"
                    ...
                    <td id="cashIn" style="width:500px">{{ session('currency') }}
            ...
            @if (isset($result[0]->cash_out) && $result[0]->cash_out == 1)
                <tr id="cash_out" style="cursor: pointer;"
                    ...
                    <td id="cashOut" style="width:500px">{{ session('currency') }}
            ...
            <tr class="f-24 form-control-label">
                ...
                <td id="CIH" style="width:500px">{{ session('currency') }} {{ number_format($CashInHand, 0) }}
                </td>
            </tr>
            ...
            @if ($heads[0]->closingBal > 0)
                <tr>
                    ...
                    <td id="CIH" style="width:500px"
                        class="{{ $closingBalance == $CashInHand ? 'text-success' : 'text-danger' }}">
