<?php $positive = (isset($heads[0]->bal) ? $heads[0]->bal : 0) +(isset($heads[0]->order_delivered_cash) ? $heads[0]->order_delivered_cash : 0)  + (isset($heads[0]->Cash) ? $heads[0]->Cash : 0) + (isset($heads[0]->paidByCustomer) ? $heads[0]->paidByCustomer : 0) + (isset($heads[0]->cashIn) ? $heads[0]->cashIn : 0);
