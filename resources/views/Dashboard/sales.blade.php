                                    ...
                                    <ul class="nav nav-tabs " role="tablist">
                                        <li class="nav-item p-5">
                                            <a class="nav-link active-active active"
                                                onclick="showHide(this,'tab-active')">Active Sales</a>
                                        </li>
                                        <li class="nav-item-self p-5">
                                            <a class="nav-link closed-active" onclick="showHide(this,'tab-closed')">Closed
                                                Sales</a>
                                        </li>
                                        <li class="nav-item-self f-right p-5">
                                            <input type="date" class="form-control" id="dateselection"
                                                style="display:none" value="{{ date('Y-m-d', strtotime('-1 days')) }}" />
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $.each(result, function(index, value) {
                        ...
                        $('#terminalTab').append(
                            "<li id=" + value.terminal_id + " onclick='getPartial(" + value
                            .terminal_id + ",1)' class='nav-item m-t-5 f-24'><a id=" + value
