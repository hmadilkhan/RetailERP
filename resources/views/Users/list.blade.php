          ...
          <tbody>
            ...
            <tr>
              <td class="text-center">
                <img width="42" height="42" src="{{ asset('storage/images/users/'.(!empty($value->image) ? $value->image : 'placeholder.jpg').'') }}" class="d-inline-block img-circle " alt="{{ !empty($value->image) ? $value->image : 'placeholder.jpg' }}">
              </td>
              ...
              <td>
                <div class="checkbox m-r-5">
                  <label>
                    <input id="changeCheckbox{{$value->id}}" onchange="changeCheckbox('changeCheckbox{{$value->id}}','{{$value->authorization_id}}')" type="checkbox" {{($value->isLoggedIn == 1 ?  'checked' : '')}} data-toggle="toggle" data-size="mini" data-width="20" data-height="20">
                  </label>
                </div>
              </td>
