				...
				<div class="row">
					...
					<div class="col-md-4 m-b-5">
						<div class="form-group row">
							<div class="col-md-10 has-success">
								<label class="custom-control custom-checkbox">
									<input type="checkbox" name="customer" class="custom-control-input" {{(count($result) != 0 ? ($result[0]->customer == 1 ? 'checked' : '') : '')}}>
									<span class="custom-control-indicator"></span>
									<span class="custom-control-description f-18">Customer (Add or Select)</span>
								</label>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 m-b-5">
						<div class="form-group row">
							<div class="col-md-10 has-success">
								<label class="custom-control custom-checkbox">
									<input type="checkbox" name="delivery" class="custom-control-input" {{(count($result) != 0 ? ($result[0]->delivery == 1 ? 'checked' : '') : '')}}>
									<span class="custom-control-indicator"></span>
									<span class="custom-control-description f-18">Delivery / Service Provider</span>
								</label>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 m-b-5">
						<div class="form-group row">
							<div class="col-md-10 has-success">
								<label class="custom-control custom-checkbox">
									<input type="checkbox" name="retail" class="custom-control-input" {{(count($result) != 0 ? ($result[0]->retail == 1 ? 'checked' : '') : '')}}>
									<span class="custom-control-indicator"></span>
									<span class="custom-control-description f-18">Retail</span>
								</label>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 m-b-5">
						<div class="form-group row">
							<div class="col-md-10 has-success">
								<label class="custom-control custom-checkbox">
									<input type="checkbox" name="wholesale" class="custom-control-input" {{(count($result) != 0 ? ($result[0]->wholesale == 1 ? 'checked' : '') : '')}}>
									<span class="custom-control-indicator"></span>
									<span class="custom-control-description f-18">Wholesale</span>
								</label>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 m-b-5">
						<div class="form-group row">
							<div class="col-md-10 has-success">
								<label class="custom-control custom-checkbox">
									<input type="checkbox" name="tables" class="custom-control-input" {{(count($result) != 0 ? ($result[0]->tables == 1 ? 'checked' : '') : '')}}>
									<span class="custom-control-indicator"></span>
									<span class="custom-control-description f-18">Tables</span>
								</label>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 m-b-5">
						<div class="form-group row">
							<div class="col-md-10 has-success">
								<label class="custom-control custom-checkbox">
									<input type="checkbox" name="token_print" class="custom-control-input" {{(count($result) != 0 ? ($result[0]->token_print == 1 ? 'checked' : '') : '')}}>
									<span class="custom-control-indicator"></span>
									<span class="custom-control-description f-18">Token Print</span>
								</label>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 m-b-5">
						<div class="form-group row">
							<div class="col-md-10 has-success">
								<label class="custom-control custom-checkbox">
									<input type="checkbox" name="prepayment" class="custom-control-input" {{(count($result) != 0 ? ($result[0]->prepayment == 1 ? 'checked' : '') : '')}}>
									<span class="custom-control-indicator"></span>
									<span class="custom-control-description f-18">Estimate / PrePayment</span>
								</label>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 m-b-5">
						<div class="form-group row">
							<div class="col-md-10 has-success">
								<label class="custom-control custom-checkbox">
									<input type="checkbox" name="goods" class="custom-control-input" {{(count($result) != 0 ? ($result[0]->goods == 1 ? 'checked' : '') : '')}}>
									<span class="custom-control-indicator"></span>
									<span class="custom-control-description f-18">Goods Sales</span>
								</label>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 m-b-5">
						<div class="form-group row">
							<div class="col-md-10 has-success">
								<label class="custom-control custom-checkbox">
									<input type="checkbox" name="item_delete_pos" class="custom-control-input" {{(count($result) != 0 ? ($result[0]->item_delete_pos == 1 ? 'checked' : '') : '')}}>
									<span class="custom-control-indicator"></span>
									<span class="custom-control-description f-18">POS (Item Delete)</span>
								</label>
							</div>
						</div>
					</div>
