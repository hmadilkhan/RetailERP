 ...
 <section class="panels-wells">
               ...
               <div class="card">
                  ...
                  <div class="card-block">
                     ...
                     <form method="POST" action="{{ url('/store-user') }}" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
						...
						<div id="multipleBranch" class="col-md-4" style="display:none;" >
                            ...
                            <div class="form-group {{ $errors->has('role') ? 'has-danger' : '' }}">
                                <label class="form-control-label">Select Roles</label>
                                 <i id="btn_role" class="icofont icofont-plus f-right text-success" data-toggle="tooltip" data-placement="top" title="Add Role" ></i>
                       ...
                       <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="email" id="email" class="form-control" placeholder="something@gmail.com" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-control-label">Contact Number</label>
                                <input type="text" name="contact" id="contact" class="form-control" placeholder="0300-1234567" />
                            </div>
                        </div>
                           ...
                           <div class="modal-dialog modal-md" role="document">
                              <div class="modal-content">
                                 ...
                                 <div class="modal-footer">
                                    <button type="button" id="btn_depart" class="btn btn-success waves-effect waves-light" onClick="addrole()">Create Role</button>
                                 </div>
                              </div>
                           </div>
                        </div> 
              ...
              console.log(resp);
                if(resp != 2){
                     ...
                     for(var count=0; count < resp.length; count++){
                      $("#role").append(
                        "<option value='"+resp[count].role_id+"'>"+resp[count].role+"</option>");
                     }
                     $('#rolename').val('')
                  }
                  else
