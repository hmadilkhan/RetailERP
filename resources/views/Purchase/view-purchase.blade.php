   ...
   <div class="card-block">
    <ul class="nav nav-tabs md-tabs m-b-20">
      <input type="hidden" name="type" id="type" value="Draft" />
           <li class="nav-item">
               <a class="nav-link active text-size" id="draft" onclick="changeTab(this,'Draft')">Draft</a>
               <div class="slide"></div>
           </li>
            <li class="nav-item">
               <a class="nav-link text-size" id="placed" onclick="changeTab(this,'Placed')">Placed</a>
               <div class="slide"></div>
           </li>
           <li class="nav-item">
               <a class="nav-link text-size" id="received" onclick="changeTab(this,'Received')">Received</a>
               <div class="slide"></div>
           </li>
           <li class="nav-item">
               <a class="nav-link text-size" id="cancelled" onclick="changeTab(this,'Cancelled')">Cancelled</a>
               <div class="slide"></div>
           </li>
             <li class="nav-item">
               <a class="nav-link text-size" id="completeReturn" onclick="changeTab(this,'Partially Return')">Partially Return</a>
               <div class="slide"></div>
           </li>
            <li class="nav-item">
               <a class="nav-link text-size" id="completeReturn" onclick="changeTab(this,'Complete Return')">Complete Return</a>
               <div class="slide"></div>
           </li>
           <li class="nav-item">
               <a class="nav-link text-size" id="complete" onclick="changeTab(this,'Complete')">Complete</a>
               <div class="slide"></div>
           </li>
           <li class="nav-item">
               <a class="nav-link text-size" id="partially-received" onclick="changeTab(this,'Partially Received')">Partially Received</a>
               <div class="slide"></div>
           </li>
           </ul>
