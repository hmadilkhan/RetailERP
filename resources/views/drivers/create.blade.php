...
@section('content')
	<section class="panels-wells">
		...
		<div class="card-header">
			<h5 class="card-header-text"> Create Driver</h5>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group {{ $errors->has('name') ? 'has-danger' : '' }} ">
							...
							<input type="text" name="name" id="name" placeholder="Driver Name" class="form-control" value="{{ old('name') }}"/>
							 @if ($errors->has('name'))
					...
					<div class="col-md-4">
						<div class="form-group {{ $errors->has('mobile') ? 'has-danger' : '' }} ">
							...
							<input type="text" name="mobile" id="mobile" placeholder="Driver Mobile Number" class="form-control" value="{{ old('mobile') }}"/>
					...
					<div class="col-md-4">
						<div class="form-group {{ $errors->has('license_no') ? 'has-danger' : '' }} ">
							...
							<input type="text" name="license_no" id="license_no" placeholder="Driver License No." class="form-control" value="{{ old('license_no') }}"/>
					...
					<div class="col-md-4">
						<div class="form-group {{ $errors->has('nic_no') ? 'has-danger' : '' }} ">
							...
							<input type="text" name="nic_no" id="nic_no" placeholder="Driver NIC No." class="form-control" value="{{ old('nic_no') }}"/>
					...
					<div class="contact-card-button m-t-20 f-right">
						<button type="submit" class="btn btn-md btn-info waves-effect waves-light">
						  <i class="icofont icofont-plus m-r-5"> </i>Save Driver
						</button>
					</div>  
				</div>
			</form>
