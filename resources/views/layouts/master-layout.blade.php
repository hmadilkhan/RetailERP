          ...
          $.ajax({
                ...
                success : function(result){
					...
					if(result.order.length == 1){
							...
							var body = "Hey you received new "+result.order[0].payment_mode+" Sales Order # " + result.order[0].id
					...
					if(result.onlineorders.length == 1){
							var title = result.onlineorders[0].company_name + " (" + result.onlineorders[0].branch_name + ")";
          ...
          $.ajax({
                ...
                success : function(result){
				   ...
				   if(totalAmount != null && totalCustomers > 0){ 
						...
						var body = "Today you have to receive payment of "+totalAmount+" from "+totalCustomers+" Customers.";
