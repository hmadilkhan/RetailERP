...
@section('breadcrumtitle','Modules Permissions')

@section('navcontorlpanel','active')
@section('navmodules','active')
    ...
    <section class="panels-wells">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-header-text">Modules Permissions</h5>
                    </div>
                    <div class="card-block">
                        <div class="row ">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <label class="form-control-label">Select Modules:</label>
                                    <select name="pages" id="pages" data-placeholder="Select Modules" class="form-control select2"  >
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-header-text">Companies Modules Details</h5>
                        <a class="f-right" href="{{ url('/modules-permissions')}}">refresh</a>
                    </div>
                    <div class="card-block">
                                ...
                                @for($i=0;$i < sizeof($companies);$i++)
                                    <tr>
                                        ...
                                        <td style="cursor: pointer;"  >
                                            @for($j=0;$j < sizeof($modulesdetails);$j++)
                                                @if($modulesdetails[$j]->company_id == $companies[$i]->company_id)
                                                    {{ $modulesdetails[$j]->page_name }},
                                                @endif
                                            @endfor
                                        </td>
                                        <td class="action-icon">
                                            ...
                                            <i class="icofont icofont-ui-delete text-danger f-18" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" onclick="remove('{{$companies[$i]->company_id}}')"></i>
    ...
    <script type="text/javascript">
        ...
        function store() {
            if($('#company').val() == 0)
            {
                ...
                swal({
                    title: "Error",
                    text: "Please Select Module First!",
                    type: "error"
                });
            }
            else{
                $.ajax({
                    url: "{{url('/insert-modules')}}",
                    type: 'POST',
                    data:{_token:"{{ csrf_token() }}",
                        dataType:"json",
                        pages:$('#pages').val(),
